package
{
   ...
   public class Habbo extends MovieClip
   {
      ...
      public static const const_22:String = "client.init.volter.retry";
      ...
      private function method_1(param1:IOErrorEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc2_.removeEventListener(IOErrorEvent.IO_ERROR,method_1);
      ...
      {
         trackLoginStep(const_7);
         reportCrash("Failed to finalize main swf preloading: " + param1.text + " / HTTP status: " + var_4,const_8,null);
      }
      ...
      private function loadVolter(param1:Boolean = false) : void
      {
         ...
         if(param1)
         {
            ...
            _loc3_.contentLoaderInfo.addEventListener(IOErrorEvent.IO_ERROR,method_1);
         }
         else
         {
