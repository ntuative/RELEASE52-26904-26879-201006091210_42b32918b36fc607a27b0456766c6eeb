package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationViewManager implements IUpdateReceiver
   {
      ...
      private static const const_527:int = 4;
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         var _loc1_:int = const_527;
         var _loc2_:int = 0;
         while(_loc2_ < var_244.length)
         {
            _loc3_ = var_244[_loc2_] as HabboNotificationItemView;
            if(_loc1_ + HabboNotificationItemView.const_573 < _loc3_.verticalPosition)
            {
               return _loc1_;
            }
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_573 + const_527;
            _loc2_++;
         }
         return _loc1_;
      }
      ...
      public function showItem(param1:HabboNotificationItem) : void
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(_assetLibrary.getAssetByName("layout_notification_xml"),_windowManager,var_2214,var_423,_toolbar);
      ...
      {
         return getNextAvailableVerticalPosition() + HabboNotificationItemView.const_573 < 540;
      }
   }
}
