package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1064:String = "badges";
      
      private static const const_1069:String = "pet_inventory";
      
      private static const const_1063:String = "pixelbalance";
      
      private static const const_1068:String = "credits";
      
      private static const const_1065:String = "inventory";
      
      private static const const_1066:String = "friendlist";
      
      private static const const_1067:String = "selectfurni";
      
      private static const const_1070:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_569:ParkBusDialogManager;
      
      private var var_571:IHabboToolbar;
      ...
      private var var_677:ClubEndingNotification;
      ...
      private var var_678:ClubGiftNotification;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1358);
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_678 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,_catalog);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1027)
         {
            return;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_571)
         {
            var_571.release(new IIDHabboToolbar());
            var_571 = null;
         }
         if(_windowManager)
         {
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1385);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_1700)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_833);
            var_1700 = true;
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1069:
               if(var_11)
               {
                  var_11.toggleInventoryPage(InventoryCategory.const_146);
               }
               break;
            case const_1067:
               break;
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc5_,NotificationType.const_833,_loc6_);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_570.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_56);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_850,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_167 || param2.type == WindowEvent.const_669)
         {
            param1.dispose();
         }
      }
      ...
      {
         if(var_391.isSpaceAvailable() && false)
         {
            var_391.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_569 == null)
         {
            var_569 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_569 != null)
         {
            var_569.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_999.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_570.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_56);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_)
         {
            addItem(_loc7_.value,NotificationType.const_1397,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_570.createAvatarImage(param2,AvatarScaleType.const_56);
         if(_loc7_ != null)
         {
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1177)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               var_677 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,_assets,_windowManager,_catalog,_localization);
            }
         }
      }
      ...
      {
         var_571 = IHabboToolbar(param2);
         var_571.events.addEventListener(HabboToolbarEvent.const_89,onHabboToolbarEvent);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_339.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_1049);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_1049);
            }
         }
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_89)
         {
            ...
            var_391 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_808["styles"],var_808["view"],var_571);
            ...
            registerUpdateReceiver(var_391,1);
            registerUpdateReceiver(this,2);
            var_339.events.addEventListener(BadgeImageReadyEvent.const_133,onBadgeImage);
            var_571.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
         }
      }
   }
}
