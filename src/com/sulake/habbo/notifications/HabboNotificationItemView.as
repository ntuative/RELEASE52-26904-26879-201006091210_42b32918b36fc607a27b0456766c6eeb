package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_573:int = 70;
      
      private static const const_796:int = 2;
      
      public static const const_456:int = 4;
      
      private static const const_797:int = 3;
      
      private static const const_429:int = 1;
      ...
      private var var_240:HabboNotificationItem;
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         if(_window.height < var_1535)
         {
            _window.height = var_1535;
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(var_36)
         {
            ...
            case const_429:
               var_887 += param1;
               _loc2_ = Number(var_887) / Number(var_423["time_fade_in"]);
               if(var_887 > int(var_423["time_fade_in"]))
               {
                  startDisplay();
               }
               adjustBlend(_loc2_);
            ...
            case const_796:
               var_1061 += param1;
               if(var_1061 > int(var_423["time_display"]) && !var_1276)
               {
                  startFadeOut();
               }
               break;
            case const_797:
               var_888 += param1;
               _loc3_ = 1 - Number(var_888) / Number(var_423["time_fade_out"]);
               adjustBlend(_loc3_);
               if(var_888 > int(var_423["time_fade_in"]))
               {
                  startIdling();
               }
         }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         if(false)
         {
            if(false)
            {
               _window.x = _loc5_ + const_456;
            }
            else
            {
               _window.x = _loc6_ - 0 - const_456;
            }
         }
         else if(false)
         {
         ...
         if(false)
         {
            if(false)
            {
               _window.y = _loc3_ + var_598;
            }
            else
            {
               _window.y = _loc4_ - 0 - var_598;
            }
         }
         else if(false)
         {
      ...
      {
         if(param1.badgeId != var_240.style.iconSrc)
         {
            return;
         }
