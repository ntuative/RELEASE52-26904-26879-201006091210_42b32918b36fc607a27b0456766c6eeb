package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpReportUserSelection extends HelpViewController
   {
      ...
      override public function update(param1:* = null) : void
      {
         ...
         var_624 = main.component.userRegistry.getRegistry();
         if(false)
         {
         ...
         var i:int = 0;
         while(i < var_624.length)
         {
            u = var_624.getWithIndex(i);
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(_loc3_ < 0 || _loc3_ > var_624.length)
         {
            return;
         }
         var _loc4_:UserRegistryItem = var_624.getWithIndex(_loc3_);
         if(_loc4_ == null)
         {
            return;
         }
