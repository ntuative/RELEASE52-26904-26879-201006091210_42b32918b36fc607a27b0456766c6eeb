package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private static var var_1484:uint = 13232628;
      
      private static var var_1795:uint = 11129827;
      ...
      private var var_580:IWindowContainer;
      
      private var var_825:NameSuggestionListRenderer;
      ...
      public function setNameAvailableView() : void
      {
         ...
         var_29.localization.registerParameter("help.tutorial.name.available","name",var_346);
      ...
      private function showSelectionView() : void
      {
         if(!var_580)
         {
            var_580 = createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!var_580)
            {
               return;
            }
            _window.content.addChild(var_580);
         }
      ...
      public function showMainView() : void
      {
         if(!_window)
         {
            ...
            var_1195 = _window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_981:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_980:
            ...
            case ChangeUserNameResultMessageEvent.var_982:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_1150:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1151 || param1 == ChangeUserNameResultMessageEvent.var_1150)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         var_825 = new NameSuggestionListRenderer(var_29);
         var _loc6_:int = var_825.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1484;
