package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(var_773 >= 0 && var_185.length > var_773)
         {
            _loc2_ = var_185[var_773];
            if(_loc2_)
            {
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         while(_loc5_ < var_212.length)
         {
            ...
            {
               if(_loc7_.length > var_212[_loc5_])
               {
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         deselectColorIndex(var_212[param2],param2);
         var_212[param2] = param1;
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= var_212[param1])
         {
            return null;
         }
      ...
      {
         return var_185[var_773] as AvatarEditorGridPartItem;
      }
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         var_212 = new Array(param1.length);
         var _loc3_:int = 0;
