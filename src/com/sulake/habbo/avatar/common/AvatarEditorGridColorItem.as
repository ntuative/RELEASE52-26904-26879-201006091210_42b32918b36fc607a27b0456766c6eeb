package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_686.width,var_686.height,true,0);
            _loc1_.bitmap.copyPixels(var_686,var_686.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_822.width,var_822.height,true,0);
            _loc5_ = var_822.clone();
            _loc5_.colorTransform(_loc5_.rect,var_685.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(_isSelected)
            {
               _loc3_.bitmap = new BitmapData(var_687.width,var_687.height,true,16777215);
               _loc3_.bitmap.copyPixels(var_687,var_687.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
