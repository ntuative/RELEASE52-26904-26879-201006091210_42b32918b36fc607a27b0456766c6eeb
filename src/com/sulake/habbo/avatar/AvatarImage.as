package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:String = null)
      {
         ...
         if(param5)
         {
            ...
            if(_loc6_)
            {
               ...
               {
                  if(!var_432.hasPartType(_loc8_))
                  {
                     _loc9_ = var_80.getDefaultPartSet(_loc8_,param5);
                     if(_loc9_)
                     {
                        var_432.updatePart(_loc8_,_loc9_.id,[0]);
                     }
                  }
                  else
                  {
                     _loc10_ = _loc7_.getSetType(_loc8_);
                     _loc11_ = _loc10_.getPartSet(var_432.getPartSetId(_loc8_));
                     if(!_loc11_)
                     {
                        _loc12_ = var_80.getDefaultPartSet(_loc8_,param5);
                        var_432.updatePart(_loc8_,_loc12_.id,[0]);
                     }
                  }
               }
            }
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_47 || param1 == AvatarSetType.const_38)
         {
            var_2359 = param2;
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(_loc3_ != null)
         {
            if(false)
            {
               ...
               if(param2)
               {
                  return (var_429[_loc3_] as BitmapData).clone();
               }
               _image = var_429[_loc3_] as BitmapData;
               var_1079 = true;
               return _image;
            }
         }
         var _loc4_:AvatarImageCache = getCache();
         var _loc5_:AvatarCanvas = var_80.getCanvas(var_149,var_251.definition.geometryType);
         if(var_1079 || _image == null || _loc5_ != null && (_image.width != _loc5_.width || _image.height != _loc5_.height))
         {
            _loc5_ = var_80.getCanvas(var_149,var_251.definition.geometryType);
            if(_loc5_ == null)
            {
               return null;
            }
            if(_image != null && !var_1079)
            {
               _image.dispose();
            }
         ...
         var _loc6_:Array = var_80.getBodyParts(param1,var_251.definition,var_92);
         _image.lock();
         ...
         while(_loc8_ >= 0)
         {
            ...
            _loc10_ = _loc4_.getImageContainer(_loc9_,var_555);
         ...
         if(_loc3_ != null)
         {
            var_429.add(_loc3_,_image.clone());
         }
         if(_image && param2)
         {
            return _image.clone();
      ...
      {
         if(var_1309 && false && var_92 == var_2359)
         {
            return var_92 + var_742 + var_555 % 4;
         }
         return null;
      }
