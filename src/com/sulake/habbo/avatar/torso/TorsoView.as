   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_35)
         {
            ...
            var_35["null"] = new AvatarEditorGridView(_model,FigureData.const_194,_windowManager,_assetLibrary);
            var_35["null"] = new AvatarEditorGridView(_model,FigureData.const_183,_windowManager,_assetLibrary);
         ...
         if(_model && var_148 == "")
         {
            _model.switchCategory(FigureData.const_183);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case "tab_jacket":
                  switchCategory(FigureData.const_194);
                  break;
               case "tab_shirt":
