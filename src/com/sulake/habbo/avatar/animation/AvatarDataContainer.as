package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1548:Number = 1.0;
      
      private var _b:uint;
      
      private var var_1551:Number = 1.0;
      ...
      private var var_1549:Number = 1.0;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1549,var_1551,var_1548,_alphaMultiplier);
         var_1087 = generatePaletteMapForGrayscale(var_2116,var_2115);
      }
      
      public function get reds() : Array
      {
         return var_1087.getValue("reds") as Array;
      }
      ...
      {
         return var_1087.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1087.getValue("greens") as Array;
      }
      ...
      {
         return var_1087.getValue("alphas") as Array;
      }
