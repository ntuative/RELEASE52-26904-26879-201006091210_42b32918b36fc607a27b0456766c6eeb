package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements ISideContentView
   {
      ...
      public function WardrobeView(param1:WardrobeModel)
      {
         ...
         var_799 = _window.findChildByName("hc_slots") as IItemListWindow;
         var_1143 = _window.findChildByName("vip_slots") as IItemListWindow;
      ...
      public function update() : void
      {
         ...
         if(var_799)
         {
            var_799.removeListItems();
         }
         if(var_1143)
         {
            var_1143.removeListItems();
         }
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(_loc3_ < 5)
            {
               if(var_799)
               {
                  var_799.addListItem(_loc2_.view);
                  _loc2_.view.visible = true;
               }
            }
            else if(var_1143)
            {
               var_1143.addListItem(_loc2_.view);
               _loc2_.view.visible = true;
            }
            _loc3_++;
         }
