package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         if(_loc4_)
         {
            var_1117 = _loc4_.content as BitmapData;
         }
         if(_window != null)
         {
            var_336 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      public function udpate(param1:BitmapData) : void
      {
         if(var_336 && var_1117)
         {
            var_336.bitmap = new BitmapData(var_336.width,var_336.height,true,16777215);
            var_336.bitmap.copyPixels(var_1117,var_1117.rect,new Point(0,0 - 0 - 8));
            var_336.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
         }
      }
   }
}
