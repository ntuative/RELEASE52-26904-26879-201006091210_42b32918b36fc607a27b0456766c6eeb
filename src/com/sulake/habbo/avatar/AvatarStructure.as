package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1486:PartOffsetData;
      
      private var var_828:AvatarActionManager;
      
      private var var_172:IAssetLibrary;
      
      private var var_827:IAssetLibrary;
      
      private var var_1796:AvatarRenderManager;
      
      private var var_302:FigureData;
      
      private var var_653:AnimationData;
      
      private var _geometry:AvatarModelGeometry;
      
      private var var_694:String;
      
      private var var_1485:AvatarStructureDownloadSet;
      
      private var var_1197:Array;
      
      private var var_693:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_172 = param2;
         var_827 = param3;
         var_302 = new FigureData();
         var_399 = new PartSetsData();
         var_653 = new AnimationData();
         var_1485 = new AvatarStructureDownloadSet();
         var_693 = new AnimationManager();
         var_694 = param4;
         var_1486 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_828.getActionDefinitionWithState(param1);
      }
      ...
      public function init() : void
      {
         ...
         switch(var_694)
         {
            case AvatarType.const_100:
               _loc1_ = var_172.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_399.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_172.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!var_653.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_172.getAssetByName("HabboAvatarFigure").content as XML;
               if(!var_302.parse(_loc3_))
               {
                  return;
               }
               break;
            case AvatarType.PET:
               _loc1_ = var_172.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_399.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_172.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!var_653.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_172.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_302.parse(_loc3_))
               {
                  return;
               }
      ...
      {
         return var_828.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_302.injectXML(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_828.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_693.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = var_399.addPartDefinition(_loc11_);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1366[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_828.getDefaultAction();
         var _loc9_:Array = var_399.getActiveParts(param3.definition);
         var _loc11_:Array = new Array();
         if(param3.definition.isAnimation)
         {
            _loc19_ = param3.definition.state + "." + param3.actionParameter;
            _loc10_ = var_693.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_302.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_302.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
                  ...
                  if(_loc27_ != null)
                  {
                     ...
                     for each(_loc28_ in _loc27_.parts)
                     {
                        ...
                        {
                           _loc29_ = [0];
                           _loc30_ = var_653.getAction(param3.definition);
                           if(_loc30_ != null)
                           {
                           ...
                           _loc13_ = var_399.getPartDefinition(_loc28_.type);
         ...
         for each(_loc12_ in _loc14_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc9_.indexOf(_loc12_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_399.getPartDefinition(_loc12_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_694 + " ready to go!");
         if(var_694 == AvatarType.const_100)
         {
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_100:
               if(var_172.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_172.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_172.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_172.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_100:
               if(var_172.hasAsset(_loc5_))
               {
                  var_172.removeAsset(var_172.getAssetByName(_loc5_));
               }
               var_1485.add(new AvatarStructureDownload(var_172,_loc5_,var_302));
               break;
            case AvatarType.PET:
         }
         var_1485.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_693.getAnimation(param1);
      }
      ...
      {
         var_828 = new AvatarActionManager(var_172,var_694);
      }
      ...
      public function getMandatorySetTypeIds() : Array
      {
         ...
         var_1197 = var_302.getMandatorySetTypeIds();
         return var_1197;
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return var_302.getDefaultPartSet(param1,param2);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_827.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_827.getAssetByName("dance" + _loc1_).content as XML;
            var_693.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_827.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_827.getAssetByName("fx" + _loc1_).content as XML;
            var_693.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_302.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_302.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         var_1486.loadOffsets(var_827);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return var_828.sortActions(param1);
      }
   }
}
