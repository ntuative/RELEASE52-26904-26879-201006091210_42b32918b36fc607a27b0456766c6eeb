package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1460:int = 60000;
      ...
      {
         if(var_599 == param1 || var_599 == GeometryType.const_971 && param1 == GeometryType.const_1003 || param1 == GeometryType.const_971 && var_599 == GeometryType.const_1003)
         {
            var_599 = param1;
            return;
         }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  ...
                  if(_loc18_.type == AnimationLayerData.const_551)
                  {
                     if(_loc18_.action != null)
                     {
                  ...
                  else if(_loc18_.type == AnimationLayerData.const_488)
                  {
                     _loc4_ = _loc8_;
                  }
                  _loc7_ = true;
         ...
         if(_loc16_ == null)
         {
            ...
            _loc10_ = var_80.getParts(param1,var_901.getFigure(),_loc6_,var_599,_loc4_,_loc13_,_loc14_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_80.getCanvas(var_149,var_599);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc24_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1181[param1])
            {
            ...
            _loc9_ = var_149 + "_" + _loc15_.assetPartDefinition + "_" + _loc10_ + "_" + _loc11_ + "_" + _loc18_ + "_" + _loc12_;
            _loc14_ = _assets.getAssetByName(_loc9_) as BitmapDataAsset;
            if(_loc14_ == null)
            {
               _loc9_ = var_149 + "_std_" + _loc10_ + "_" + _loc11_ + "_" + _loc18_ + "_0";
               _loc14_ = _assets.getAssetByName(_loc9_) as BitmapDataAsset;
            }
            if(!(!_loc14_ || !_loc14_.content))
            {
               ...
               if((_loc30_ == AvatarAction.const_930 || _loc30_ == AvatarAction.const_438) && (_loc6_ == AvatarBodyPartType.const_223 || _loc6_ == AvatarBodyPartType.const_1373 || _loc6_ == AvatarBodyPartType.const_1178) && _loc7_.color != null)
               {
               ...
               if(_loc22_)
               {
                  if(var_149 == AvatarScaleType.const_56)
                  {
                     _loc31_.x += 65;
                  }
                  else
      ...
      public function resetBodyPartCache(param1:IActiveActionData) : void
      {
         ...
         if(var_132 != null)
         {
            ...
            {
               _loc5_ = var_132.getValue(_loc4_) as AvatarImageBodyPartCache;
               if(_loc5_ != null)
               {
