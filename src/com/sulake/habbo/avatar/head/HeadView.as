   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_35)
         {
            ...
            var_35["null"] = new AvatarEditorGridView(_model,FigureData.const_145,_windowManager,_assetLibrary);
            var_35["null"] = new AvatarEditorGridView(_model,FigureData.const_195,_windowManager,_assetLibrary);
            var_35["null"] = new AvatarEditorGridView(_model,FigureData.const_170,_windowManager,_assetLibrary);
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "tab_hair":
                  ...
                  break;
               case "tab_hat":
                  switchCategory(FigureData.const_195);
                  break;
