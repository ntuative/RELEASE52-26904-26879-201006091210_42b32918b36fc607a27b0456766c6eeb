package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_1945 = parseInt(param1.@precedence);
         var_1948 = String(param1.@activepartset);
         var_1947 = String(param1.@assetpartdefinition);
         var_1949 = String(param1.@lay);
         var_599 = String(param1.@geometrytype);
         var_1951 = Boolean(parseInt(param1.@main));
         var_1950 = Boolean(parseInt(param1.@var_165));
         var_1952 = Boolean(parseInt(param1.@animation));
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         if(var_605.getValue(param1) == null)
         {
            var_605.add(param1,new Map());
         }
         var _loc4_:Map = var_605.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = var_605.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      {
         return var_1245.concat(getTypePrevents(param1));
      }
