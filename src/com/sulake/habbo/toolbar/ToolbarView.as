package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_541:String = "LEFT";
      
      private var var_213:IWindowContainer;
      
      private var var_632:Array;
      
      private var var_1607:Number = 15;
      
      private var _events:IEventDispatcher;
      
      private var var_269:ToolbarBarMenuAnimator;
      
      private var var_1608:Number = 5;
      
      private var var_282:Array;
      
      private var var_141:Number = 50;
      
      private var var_1382:Number = 0;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_141 = _window.width;
         var_213 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_57,HabboWindowStyle.const_910,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1115 = String(_loc7_.relocate_by_drag.@state) == "RoomVisualizationData";
         if(var_1115)
         {
         ...
         var_1382 = _loc7_.toolbar.@margin_bottom;
         var_1607 = _loc7_.toolbar.@min_group_margin;
         var_1608 = _loc7_.toolbar.@margin_to_extrabar;
         ...
         createGroupsFromXmlList(_loc8_,var_282,param1,param2,_window,var_269);
         createGroupsFromXmlList(_loc9_,var_632,param1,param2,var_213,var_269);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_141,var_541,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         {
            case "LEFT":
               _window.width = var_141;
               _window.height = _loc1_.height;
               _window.x = 0;
               _window.y = 0;
               var_213.x = var_141 + var_1608;
               var_213.y = 0;
               _loc4_ = 0;
               break;
            case "RIGHT":
               _window.width = var_141;
               _window.height = _loc1_.height;
               _window.x = _loc1_.width - var_141;
               _window.y = 0;
               var_213.x = 0;
               var_213.y = 0;
               _loc4_ = 0;
            ...
            case "TOP":
               ...
               _window.height = var_141;
               _window.x = 0;
               _window.y = 0;
               var_213.x = 0;
               var_213.y = var_141 + var_1608;
               _loc4_ = 0;
               break;
            case "BOTTOM":
               _window.width = _loc1_.width;
               _window.height = var_141;
               _window.x = 0;
               _window.y = _loc1_.height - var_141;
               var_213.x = 0;
               var_213.y = 0;
               _loc4_ = 0;
         }
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1607,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1382) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1607,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1382) / -1));
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IWindowContainer, param6:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc10_ < param1.length())
         {
            ...
            _loc9_ = new ToolbarIconGroup(param3,param4,_loc10_,_events,param5,param6,var_141);
      ...
      private function getTargetOrientationFromXY(param1:Number, param2:Number) : String
      {
         ...
         if(param1 >= _loc3_.width - var_141)
         {
            return "RIGHT";
         }
         if(param2 <= var_141)
         ...
         if(param2 >= _loc3_.height - var_141)
         {
            return "BOTTOM";
         }
         return null;
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_141,var_541);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < var_632.length)
         {
            _loc2_ = var_632[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_541);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_141,var_541);
         }
      }
