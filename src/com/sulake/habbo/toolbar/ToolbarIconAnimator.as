package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         {
            var_836 = getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_835.push(new XML());
               var_834.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_834[var_53] = param6.clone();
         }
      ...
      {
         if(var_1202 == true || var_697 == 0)
         {
            if(false)
            {
               ++var_53;
               if(var_53 >= var_835.length)
               {
                  var_53 = 0;
                  ++var_697;
               }
      ...
      {
         return var_835.length;
      }
      
      public function hasNextState() : Boolean
      {
         return var_1202 == false && var_697 == 1 && var_1308 != var_36;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         if(var_836 != null)
         {
            _loc3_ = new BitmapData(Math.max(param2.width,var_836.width),Math.max(param2.height,var_836.height));
            _loc3_.copyPixels(var_836,var_836.rect,new Point(0,0));
      ...
      {
         var _loc2_:* = null;
         if(var_53 <= var_834.length)
         {
            _loc2_ = var_834[var_53];
