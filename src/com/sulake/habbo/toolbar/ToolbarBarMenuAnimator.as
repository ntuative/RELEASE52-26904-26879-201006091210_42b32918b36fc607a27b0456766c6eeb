package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1074:Number = 25;
      ...
      private var var_1007:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1007 = param2;
         var_573 = new Timer(const_1074);
         var_573.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         param1.addEventListener(WindowEvent.const_247,windowEventListener);
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1007.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = var_1007.getIconLoc(param1.iconId);
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_574[_loc3_] = new Array();
            }
            if(var_574[_loc3_].indexOf(param1) < 0)
            {
               var_574[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_776 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_776 || param1.desktop.height - param1.y < const_1075;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         while(_loc2_ < var_472.length)
         {
            if(var_472[_loc2_] == param1.window.name)
            {
               ...
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_574[_loc3_].length)
                  {
                     repositionWindow(var_574[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
