package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      {
         return var_772.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < var_1367.length)
         {
            _loc2_ = var_772.indexOf(var_1367[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = var_319[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(var_872 + _loc3_);
                  _loc3_ += var_1365;
               }
            }
            _loc4_++;
               ...
               if(!containsIcon(_loc2_))
               {
                  ...
                  if(_loc5_.length() > 0)
                  {
                     ...
                     while(_loc9_ < _loc5_.length())
                     {
                        ...
                        _loc6_.dockMenu(_loc3_,getMenuYieldList(_loc3_),_loc5_[_loc9_].@locktoicon == "RoomVisualizationData");
                        _loc9_++;
                     }
                  }
                  else
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return var_319[var_772.indexOf(param1)];
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = var_2192.elements("menu");
         var _loc5_:int = 0;
