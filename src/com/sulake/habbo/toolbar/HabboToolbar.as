package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_304.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_897,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_163,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_169,method_10);
         events.addEventListener(HabboToolbarShowMenuEvent.const_52,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_491,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_558,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_907,onHideWindowEvent);
         var_36 = true;
      ...
      private function method_10(param1:HabboToolbarSetIconEvent) : void
      {
         if(_view != null && var_36)
         {
