package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1457:uint = 4.294967295E9;
      
      private const const_1456:uint = 4.293848814E9;
      
      private var var_898:int;
      
      private const const_1735:uint = 4.291613146E9;
      ...
      private const const_1734:int = 10;
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_235.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_897;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_897,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(const_1456) : uint(const_1457);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_437,var_79,var_1078);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc1_:IItemListWindow = var_235.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_897);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_608[_boxIndex]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_607[var_206]);
         _catalog.purchaseProductAsGift(var_437,var_79,var_1078,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
         ...
         switch(param1.type)
         {
            case WindowEvent.const_119:
               ...
               for each(_loc7_ in var_224)
               {
                  ...
                  if(_loc5_.length >= const_1734)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_2087 = _loc3_.text;
               break;
            case WindowMouseEvent.const_54:
               showSuggestions(false);
               if(var_1304)
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1517 = _loc1_.stuffTypes;
            var_608 = _loc1_.boxTypes;
            var_607 = _loc1_.ribbonTypes;
            var_897 = var_1517[0];
            _boxIndex = var_608[0];
            var_206 = var_607[0];
            initColorGrid();
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_235.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_235 == null)
         {
            var_235 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_528 == null)
         {
