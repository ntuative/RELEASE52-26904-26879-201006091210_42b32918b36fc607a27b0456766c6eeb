package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static var var_1651:XML;
      
      private static var var_1652:XML;
       
      
      private var var_2417:IWindowContainer;
      ...
      private var var_1650:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1650 == 4294967295)
            {
               var_1650 = _loc1_.color;
            }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1368;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1651) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_51 = navigator.catalog.windowManager.buildFromXML(var_1652) as IItemListWindow;
         if(var_51 == null)
         {
