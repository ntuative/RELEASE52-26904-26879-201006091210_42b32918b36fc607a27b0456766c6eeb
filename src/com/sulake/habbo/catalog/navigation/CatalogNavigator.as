package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2426:String = "magic.pixels";
      
      private var var_2427:String = "catalog.page.club";
      
      private var var_2440:String = "magic.credits";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         name_1 = _container.findChildByName("navigationListScrollbar") as IScrollbarWindow;
         if(name_1 != null)
         {
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = _catalog.configuration.getKey("client.credits.embed.enabled","false") == "RoomVisualizationData";
         if(false && _loc1_)
         {
      ...
      {
         _catalog.openCatalogPage(var_2427,true);
      }
