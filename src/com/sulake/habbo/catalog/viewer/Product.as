package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1428:IProductData;
      ...
      {
         super();
         var_1430 = param1.productType;
         var_1427 = param1.furniClassId;
         var_1146 = param1.extraParam;
         var_1145 = param1.productCount;
         var_1429 = param1.expiration;
         var_1428 = param2;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(productType)
         {
            ...
            case ProductTypeEnum.const_82:
               _loc6_ = _loc4_.getWallItemIcon(productClassId,param2,var_1146);
               break;
