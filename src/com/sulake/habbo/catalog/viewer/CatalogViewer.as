package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1498:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_437 != null)
         {
            if(var_437.pageId == param1)
            {
               return;
            }
            _container.removeChild(var_437.window);
            var_437.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1498);
         var_437 = _loc5_;
      ...
      {
         return var_437.dispatchWidgetEvent(param1);
      }
