package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function updateInfo() : void
      {
         ...
         if(_loc5_)
         {
            _loc2_ = var_29.purse.pastClubDays > const_159 ? "catalog.club_gift.past_club.long" : "catalog.club_gift.past_club";
            _loc3_ = var_29.purse.pastClubDays % const_159;
            _loc4_ = var_29.purse.pastClubDays / const_159;
         ...
         if(_loc6_)
         {
            _loc2_ = var_29.purse.pastVipDays > const_159 ? "catalog.club_gift.past_vip.long" : "catalog.club_gift.past_vip";
            _loc3_ = var_29.purse.pastVipDays % const_159;
            _loc4_ = var_29.purse.pastVipDays / const_159;
            var_29.localization.registerParameter(_loc2_,"days",_loc3_.toString());
            var_29.localization.registerParameter(_loc2_,"months",_loc4_.toString());
      ...
      {
         if(!param1 || !param2 || !var_596 || !var_29)
         {
            return;
         }
