package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_647[var_1135] as Array;
      ...
      {
         var _loc2_:Offer = var_647[var_1135][var_2274];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_485 || _loc1_.pricingModel == Offer.const_454)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_82 || _loc3_.productType == ProductTypeEnum.const_83)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(var_1134.indexOf(_loc5_) == -1)
                        {
                           var_1134.push(_loc5_);
                           var_647.push(new Array());
                        }
                        _loc6_ = var_1134.indexOf(_loc5_);
                        (var_647[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
         ...
         {
            _loc2_.sort(method_9);
         }
      }
      
      private function method_9(param1:Offer, param2:Offer) : int
      {
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_647)
         {
            if(var_2274 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_2274] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_1135 = var_987.getGridItemIndex(param1.view);
