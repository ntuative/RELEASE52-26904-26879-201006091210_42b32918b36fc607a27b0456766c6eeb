package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_899:PrizeViewer;
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_741.length)
         {
            createLevelItem(var_741[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         var_899 = new PrizeViewer();
         var_741 = recycler.getPrizeTable();
         if(var_741 == null)
         {
            return;
         }
         ...
         populateItemGrid();
         if(false && var_741[0].prizes.length > 0)
         {
            select(var_741[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1305) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_899.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
