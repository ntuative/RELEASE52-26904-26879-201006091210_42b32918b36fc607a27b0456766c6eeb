package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1373.text = "${" + _loc3_.name + "}";
            var_1372.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1373.text = "${" + _loc2_.localizationId + "}";
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_513:
                  _loc4_ = var_1416.clone();
                  if(var_655 != null)
                  {
                     var_655.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_655,var_1417,var_1305);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_208:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_272,AvatarAction.const_412);
                              _loc13_.appendAction(AvatarAction.const_408,_loc6_.productClassId);
      ...
      {
         var_1373 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         ...
         var_1654 = new Point(var_89.x,var_89.y);
         var_655 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1417 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_655 == null)
         {
         ...
         var_1416 = _loc2_.content as BitmapData;
