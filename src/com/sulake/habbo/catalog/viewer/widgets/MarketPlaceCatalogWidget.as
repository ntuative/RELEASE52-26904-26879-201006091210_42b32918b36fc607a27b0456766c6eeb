package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_928:MarketPlaceOfferData;
      
      private const const_1469:int = 1;
      ...
      private function updateList() : void
      {
         ...
         if(!var_538)
         {
            ...
            var_538 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_538)
         {
            return;
         ...
         updateStatusDisplay(const_1468,_loc2_.length);
         if(!var_440)
         {
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_538 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_538.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1469);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_441.length)
         {
            _loc4_ = 0;
         }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_929 >= var_596.length)
            {
               return true;
            }
            addListItem(var_596.getWithIndex(var_929));
            ++var_929;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_928.offerId);
            }
            return;
         }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_441));
            _loc7_.selection = 0;
         }
      }
