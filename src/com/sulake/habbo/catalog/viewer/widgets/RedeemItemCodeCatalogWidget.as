package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_1107 != null)
         {
            var_1107.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1108 != null)
         {
            var_1108.removeEventListener(WindowKeyboardEvent.const_147,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1107 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1107 != null)
         {
            var_1107.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1108 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1108 != null)
         {
            var_1108.addEventListener(WindowKeyboardEvent.const_147,windowKeyEventProcessor);
         }
      }
