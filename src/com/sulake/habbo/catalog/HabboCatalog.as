package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_427:ICatalogNavigator;
      ...
      private var var_2081:GiftWrappingConfiguration;
      ...
      private var var_1076:ClubGiftController;
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_102.credits = _loc3_.balance;
         updatePurse();
         if(!var_2083 && var_526 != null)
         {
            var_526.playSound(HabboSoundTypesEnum.const_844);
         }
         var_2083 = false;
      }
      ...
      private function createClubBuyController() : void
      {
         if(var_426 == null)
         {
            var_426 = new ClubBuyController(this);
         }
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_102:
               var_1299 = param1.session.isPrivateRoom;
               if(var_84 != null)
               {
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "RoomVisualizationData" == var_128.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = var_128.getKey("link.format.credits");
               if(_loc3_ != "")
               {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_2081 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!var_895)
         {
            if(!var_339.loadProductData(this))
            {
               return;
            }
            init();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_1076.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_427 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_102.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_102.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         var_102.isVIP = _loc2_.isVIP;
         var_102.pastClubDays = _loc2_.pastClubDays;
         var_102.pastVipDays = _loc2_.pastVipDays;
         updatePurse();
      ...
      private function createClubGiftController() : void
      {
         if(var_1076 == null)
         {
            var_1076 = new ClubGiftController(this);
         }
      }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         {
            var_426.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_427.buildCatalogIndex(_loc2_);
         if(var_1075 != "")
         {
            var_427.openPage(var_1075);
            var_1075 = "";
         }
         else
         {
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         if(param2.type == WindowEvent.const_167)
         {
            _loc3_ = var_128.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               _windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(param1 == null || var_315 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         var_315.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_102.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_102.pixels));
         var _loc1_:int = 0;
         if(true)
         {
         ...
         else
         {
            ...
            _localization.registerParameter(_loc2_,"days",String(var_102.clubDays));
            _localization.registerParameter(_loc2_,"months",String(var_102.clubPeriods));
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return var_315.getCurrentLayoutCode();
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_102.pixels = _loc2_.amount;
         updatePurse();
         if(!var_2082 && var_526 != null)
         {
            var_526.playSound(HabboSoundTypesEnum.const_937);
         }
         var_2082 = false;
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var_315.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         var_315.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_315 = new CatalogViewer(this,_loc1_,_roomEngine);
         var_315.habboCatalog = this;
      }
