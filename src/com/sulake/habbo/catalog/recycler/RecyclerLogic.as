package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_799:int = 0;
      ...
      {
         return var_1536 != RecyclerStatusMessageEvent.const_864;
      }
      
      private function get statusActive() : Boolean
      {
         return var_272 != const_799;
      }
      ...
      {
         return active && var_272 == const_371;
      }
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(false)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_192)
            {
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1027:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1349:
