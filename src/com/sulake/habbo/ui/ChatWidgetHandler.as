package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      private var var_500:Point = null;
      ...
      {
         return [RoomSessionChatEvent.const_157];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_157:
      ...
      {
         return [RoomWidgetChatMessage.const_614,RoomWidgetChatSelectAvatarMessage.const_698];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_614:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_157,_container.roomSession,0,"Version 26904-26879-201006091154");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_698:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_500 == null)
            {
               ...
               var_501.y = 0;
               var_501.z = 0;
               var_500 = _loc4_.getScreenPoint(var_501);
            ...
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_500.x || _loc8_.y != var_500.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_500,_loc5_));
