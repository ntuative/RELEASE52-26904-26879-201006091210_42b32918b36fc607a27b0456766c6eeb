   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc9_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_897,HabboToolbarIconEnum.MEMENU);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_615,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_427,onHelpTutorialEvent);
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_116,onHelpTutorialEvent);
            }
            _container = null;
         }
         _container = param1;
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_615,onFigureUpdate);
         ...
         if(var_11 != null)
         {
            (var_11 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_888,onAvatarEffectsChanged);
            (var_11 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_885,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_427,onHelpTutorialEvent);
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_116,onHelpTutorialEvent);
         }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_116:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_116));
               break;
            case HabboHelpTutorialEvent.const_427:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_401));
         }
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetGetEffectsMessage.const_630);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_537);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_623);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_758);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_678);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_720);
         _loc1_.push(RoomWidgetStopEffectMessage.const_759);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1295);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1007);
         _loc1_.push(RoomWidgetToolbarMessage.const_727);
         _loc1_.push(RoomWidgetToolbarMessage.const_718);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_353);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1384);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1015);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_710);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_730);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_704);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1274);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_574);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_612);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_601);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_335);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_708));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetDanceMessage.const_556:
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_630:
               if(var_11 != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_720:
               ...
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1014)
               {
            ...
            case RoomWidgetOpenInventoryMessage.const_678:
               ...
               if(var_11 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1043:
                        _catalog.openCatalogPage(CatalogPageName.const_1369,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1051:
                        var_11.toggleInventoryPage(InventoryCategory.const_273);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1190:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_758:
            case RoomWidgetStopEffectMessage.const_759:
            ...
            case RoomWidgetSetToolbarIconMessage.const_903:
               ...
               {
                  case RoomWidgetSetToolbarIconMessage.const_1277:
                     break;
                  default:
                     Logger.log("MeMenuWidgetHandler: unknown icon widget type: " + _loc4_.widgetType);
               }
               break;
            case RoomWidgetNavigateToRoomMessage.const_1007:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_710:
               if(_container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_727:
               ...
               break;
            case RoomWidgetToolbarMessage.const_718:
               ...
               if(_toolbar && false)
               {
                  _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_491,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_353:
               ...
               if(_container)
               {
                  ...
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_505));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_704:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_347,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_574:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_347,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_612:
            ...
            case RoomWidgetAvatarEditorMessage.const_601:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_397));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_335:
