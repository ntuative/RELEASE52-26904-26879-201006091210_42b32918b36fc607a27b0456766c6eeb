package com.sulake.habbo.ui
{
   ...
   public class FurnitureStickieWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_483;
      }
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_721,RoomWidgetStickieSendUpdateMessage.const_636,RoomWidgetStickieSendUpdateMessage.const_445];
      }
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_721:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     _loc7_ = _loc6_.getString(RoomObjectVariableEnum.const_908);
                     if(_loc7_.length < 6)
                     {
                        return null;
                     }
               ...
               break;
            case RoomWidgetStickieSendUpdateMessage.const_445:
