package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1134:String = "room_view";
      
      private var var_54:IWindowContainer;
      
      private var var_770:int = 50;
      
      private var var_2405:XML = null;
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = var_54.getChildByTag(const_1134) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = var_54.findChildByTag(const_1134) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               _loc2_.x = var_770;
               _loc2_.width = var_54.desktop.width - var_770;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = var_770;
               _loc2_.height = var_54.desktop.height - var_770;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = var_54.desktop.width;
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager) : void
      {
         ...
         while(_loc5_ < var_54.numChildren)
         {
            ...
            {
               _loc4_.addEventListener(WindowEvent.const_271,trimContainer);
            }
            _loc5_++;
         }
      }
