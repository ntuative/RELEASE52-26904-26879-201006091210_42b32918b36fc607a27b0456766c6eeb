package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               ...
               _container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_133,onBadgeImage);
            }
            if(false)
            {
         ...
         if(false)
         {
            ...
            _container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_133,onBadgeImage);
         }
         if(false)
         {
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_32:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_660);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_316);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_829);
            ...
            case RoomObjectCategoryEnum.const_40:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_324)
               {
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_469);
               }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_242)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_665);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1364;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_846;
                  }
                  if(!_loc27_)
                  {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1345);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_659.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_56);
            var_659.add(_loc2_.petId,_loc5_);
         }
         if(_loc5_ == null)
         {
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_665);
      ...
      {
         return [RoomSessionUserBadgesEvent.const_129];
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_736);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_280);
         _loc1_.push(RoomWidgetFurniActionMessage.const_599);
         _loc1_.push(RoomWidgetFurniActionMessage.const_654);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_703);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_608);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1411);
         _loc1_.push(RoomWidgetPetCommandMessage.const_767);
         _loc1_.push(RoomWidgetPetCommandMessage.const_625);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_129:
      ...
      public function dispose() : void
      {
         ...
         if(var_659 != null)
         {
            _loc1_ = var_659.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_659.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_640:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_963,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_511:
               ...
               break;
            case RoomWidgetUserActionMessage.const_736:
            ...
            case RoomWidgetUserActionMessage.const_426:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_703:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_608:
