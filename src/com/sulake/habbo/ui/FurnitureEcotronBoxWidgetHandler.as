package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_746,RoomWidgetEcotronBoxOpenMessage.const_769,RoomWidgetEcotronBoxOpenedMessage.const_1434];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_746:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_769:
