package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_108:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_754,_loc2_.userName));
               break;
            case RoomSessionDoorbellEvent.const_138:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_138,_loc2_.userName));
               break;
            case RoomSessionDoorbellEvent.const_59:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_59,_loc2_.userName));
               break;
         }
      }
      ...
      {
         return [RoomWidgetLetUserInMessage.const_768];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_768:
      ...
      {
         return [RoomSessionDoorbellEvent.const_108,RoomSessionDoorbellEvent.const_138,RoomSessionDoorbellEvent.const_59];
      }
