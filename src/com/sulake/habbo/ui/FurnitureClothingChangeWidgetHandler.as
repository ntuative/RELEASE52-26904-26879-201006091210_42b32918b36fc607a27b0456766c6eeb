package com.sulake.habbo.ui
{
   ...
   public class FurnitureClothingChangeWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private static const const_1135:String = "hr-165-45.hd-208-2.ch-250-64.lg-285-82.sh-290-64";
      ...
      public function saveFigure(param1:String, param2:String) : void
      {
         ...
         _container.roomSession.sendUpdateClothingChangeFurniture(var_159,param2,param1);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_578,RoomWidgetClothingChangeMessage.const_335,RoomWidgetAvatarEditorMessage.const_353];
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         var _loc2_:RoomWidgetClothingChangeUpdateEvent = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_358);
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_578:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc8_)
                     {
                        _loc5_ = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_340,_loc6_.id,_loc6_.category,_loc6_.roomId,_loc6_.roomCategory);
            ...
            case RoomWidgetClothingChangeMessage.const_335:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     var_159 = _loc7_.objectId;
                     _loc9_ = "null";
                     _loc10_ = _loc4_.getString(RoomObjectVariableEnum.const_943);
                     if(_loc10_ == null)
                     {
                        _loc10_ = const_1135;
                     }
                     ...
                     if(_container.avatarEditor.openEditor(_loc7_.window,this,[AvatarEditorFigureCategory.const_223,AvatarEditorFigureCategory.const_667],true))
                     {
                        _loc11_ = 0;
                        ...
                        _loc5_ = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_340,_loc7_.objectId,_loc7_.objectCategory,_loc7_.roomId,_loc7_.roomCategory);
                        _container.events.dispatchEvent(_loc5_);
                     }
                  }
               }
            ...
            case RoomWidgetAvatarEditorMessage.const_353:
               _loc5_ = new RoomWidgetClothingChangeUpdateEvent(RoomWidgetClothingChangeUpdateEvent.const_358);
               _container.events.dispatchEvent(_loc5_);
         }
         return null;
      }
