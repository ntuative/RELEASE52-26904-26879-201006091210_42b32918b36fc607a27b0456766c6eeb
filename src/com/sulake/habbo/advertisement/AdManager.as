   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_486,0,0,_loc4_,var_1644,var_970,var_969));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_2310 = int(_config.getKey("interstitial.interval","30000"));
         var_2308 = int(_config.getKey("interstitial.show.time","5000"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1410 = _loc2_.imageUrl;
         var_1644 = _loc2_.clickUrl;
         if(var_1410 != "" && var_1644 != "")
         {
            _loc3_ = var_1410;
            ...
            _loc4_ = new URLRequest(var_1410);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1411 = _loc2_.imageUrl;
         var_2309 = _loc2_.clickUrl;
         var_796 = getTimer();
         if(var_1411 != "")
         {
            _loc3_ = var_1411;
            ...
            if(var_248 == null)
            {
               var_248 = new Timer(var_2308,1);
               var_248.addEventListener(TimerEvent.TIMER_COMPLETE,interstitialTimerComplete);
            }
            if(false)
            {
               var_248.reset();
            ...
            var_248.start();
            _loc4_ = new URLRequest(var_1411);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_452,0,0,param1.bitmapData,var_2309));
            var_796 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_969 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         var _loc1_:int = getTimer() - var_796;
         if(_loc1_ > var_2310)
         {
            ++var_1646;
      ...
      {
         var_304 = param2 as IHabboCommunicationManager;
         if(var_304 == null)
         {
            return;
         }
         _connection = var_304.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_433));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_970 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
