package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      {
         var _loc2_:* = null;
         if(!var_1232 || var_1665 <= 0)
         {
            return;
         }
         var _loc1_:int = getTimer();
         if(var_1666 == 0 || _loc1_ - var_1666 > var_1665)
         {
            if(_connection != null)
            {
      ...
      {
         var_1232 = Boolean(int(param1.getKey("lagWarningLog.enabled","0")));
         var_1665 = int(param1.getKey("lagWarningLog.interval.minutes","10")) * 1000 * 60;
      }
