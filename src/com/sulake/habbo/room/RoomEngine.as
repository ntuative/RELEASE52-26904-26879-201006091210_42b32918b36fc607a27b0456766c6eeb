package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_781:int = -2;
      
      private static const const_517:String = "temporary_room";
      
      private static const const_299:String = "object_icon_sprite";
      
      private static const const_780:int = -3;
      
      private static const const_779:String = "overlay";
      
      private static const OBJECT_TYPE_SELECTION_ARROW:String = "selection_arrow";
      
      private static const const_1080:String = "tile_cursor";
      
      private static const const_300:int = -1;
      ...
      private var var_691:IRoomRendererFactory = null;
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_67 != null)
         {
            ...
            {
               return var_67.deleteWallItem(var_114,var_113,param1);
            }
         }
         return false;
      }
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         var _loc49_:* = null;
         var _loc2_:int = 0;
         for(; _loc2_ < var_300.length; _loc2_++)
         {
            _loc3_ = var_300.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_593) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_597) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_550) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_607) + 0.5;
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_67 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_32)
            {
               return var_67.modifyWallItemData(var_114,var_113,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_453 != null)
         {
            var_453.release(new IIDRoomObjectVisualizationFactory());
            var_453 = null;
         }
         if(var_43 != null)
         {
         ...
         if(var_691 != null)
         {
            var_691.release(new IIDRoomRendererFactory());
            var_691 = null;
         }
         ...
         if(var_300 != null)
         {
            ...
            {
               _loc2_ = var_300.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_691.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_954;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_611);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_596);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_705);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1032);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_875);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_939) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_884);
                  ...
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_563,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_576,var_114,var_113,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_67 != null)
         {
            return var_67.modifyRoomObject(var_114,var_113,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_616,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_761,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_570,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_43 != null)
         {
            ...
            var_43.addObjectUpdateCategory(RoomObjectCategoryEnum.const_32);
            var_43.addObjectUpdateCategory(RoomObjectCategoryEnum.const_40);
            var_43.addObjectUpdateCategory(RoomObjectCategoryEnum.const_265);
            var_43.addObjectUpdateCategory(RoomObjectCategoryEnum.const_68);
            var_43.setContentLoader(var_12);
         }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_67 != null)
         {
            var_67.handleRoomObjectEvent(param1,var_114,var_113);
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_12.sessionDataManager = var_339;
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_233,_loc12_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_316,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_348,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_866,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_829,param10);
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_252,param1,param2,param3,RoomObjectCategoryEnum.const_34));
         }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_763,param1,param2));
      }
      
      private function initializeRoomManager() : void
      {
         if(var_26 == null || var_453 == null || var_43 == null || var_691 == null || _communication == null || _habboConfiguration == null || !var_1793)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_300,RoomObjectCategoryEnum.const_68);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_43.getRoom(getRoomIdentifier(var_114,var_113));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_780,RoomObjectCategoryEnum.const_265);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_114,var_113,var_1194);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_114,var_113,var_1194);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_453 = param2 as IRoomObjectVisualizationFactory;
         if(var_12 != null)
         {
            var_12.visualizationFactory = var_453;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_26 != null)
         {
            if(false)
            {
               var_26.events.addEventListener(RoomObjectMouseEvent.const_246,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMouseEvent.const_487,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMouseEvent.const_472,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectStateChangeEvent.const_181,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectStateChangeEvent.const_699,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_121,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_142,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.ROOM_OBJECT_WIDGET_REQUEST_STICKIE,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_139,roomObjectEventHandler);
               ...
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_137,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_101,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectWidgetRequestEvent.const_128,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_432,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_481,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_430,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_STICKIE,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_414,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_507,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_400,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectFurnitureActionEvent.const_464,roomObjectEventHandler);
               ...
               var_26.events.addEventListener(RoomObjectMoveEvent.const_439,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectMoveEvent.const_389,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_288,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_384,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_342,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomAdEvent.const_345,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_404,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_893,roomObjectEventHandler);
               var_26.events.addEventListener(RoomObjectRoomActionEvent.const_425,roomObjectEventHandler);
               var_26.events.addEventListener(AvatarWalkWarpingWarningEvent.const_490,warningEventHandler);
            }
         }
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_579) != 0)
         {
            return false;
         }
         if(var_67 != null)
         {
            return var_67.initializeRoomObjectInsert(var_114,var_113,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_252,param1,param2,param3,RoomObjectCategoryEnum.const_40));
         }
         return true;
      }
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_928,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_834,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_32:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_233));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_471);
                     break;
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_233,_loc10_,false);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_316,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_348,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_954,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_252,param1,param2,param3,RoomObjectCategoryEnum.const_32));
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_263.events.addEventListener(AdEvent.const_486,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_779) as Sprite;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = var_300.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_571,param1,param2));
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_691 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!var_487 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = var_43.getRoom(const_517);
         if(_loc10_ == null)
         {
            _loc10_ = var_43.createRoom(const_517,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.const_34:
            case RoomObjectCategoryEnum.const_32:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_233,int(param2));
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_471,param8);
               break;
            case RoomObjectCategoryEnum.const_40:
            ...
            case RoomObjectCategoryEnum.const_68:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_189,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_688,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_620,_loc19_);
         ...
         {
            var_1016.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_994,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_781,RoomObjectCategoryEnum.const_265);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.x = var_1483 - _loc12_.width / 2;
               _loc11_.y = var_1482 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_463,var_114,var_113,-1,RoomObjectCategoryEnum.const_234));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_67 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_300,const_516);
                  var_67.handleRoomObjectEvent(_loc14_,var_114,var_113);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_114,var_113,var_1194);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = var_1483 - _loc6_.data.width / 2;
               _loc11_.y = var_1482 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_12 != null)
         {
            ...
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_328,param1.image,true);
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_940,param1.adWarningL,true);
            var_12.addGraphicAsset(var_12.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1022,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_852,RoomObjectVariableEnum.const_328,param1.clickUrl);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomInstanceData = var_300.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            var_300.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_67 != null)
         {
            var_67.cancelRoomObjectInsert(var_114,var_113);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_43.getRoom(const_517);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_994);
               ...
               _loc13_ = var_1016.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_114,var_113,const_300,RoomObjectCategoryEnum.const_68,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_ = _loc7_.createRoomObject(const_300,_loc12_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_950,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_579,1,true);
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_300,const_516,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_579,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_611,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_593,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_550,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_597,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_607,_loc19_);
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_616,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_761,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_570,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_447,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_204);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_596,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_705,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_596,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_705,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1032,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_875,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_781,const_1080,RoomObjectCategoryEnum.const_265);
         _loc7_.createRoomObject(const_780,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_265);
         return _loc7_;
      }
