package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1455:int = 1500;
      
      private var var_1457:int = 255;
      
      private var var_1456:int = 255;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_970,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_632,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_659,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_536,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_540,1);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_832,int(param1.bgOnly));
         var_1174 = _color;
         var_1457 = var_1402;
         var_1001 = _loc3_;
         var_1456 = _loc4_;
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_834:
               param2.setNumber(RoomObjectVariableEnum.const_659,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_928:
               param2.setNumber(RoomObjectVariableEnum.const_536,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_540,_loc3_);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_447:
               ...
               var_424.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_563:
               _loc4_ = var_424.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = var_424.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_842,_loc7_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_616:
               param2.setString(RoomObjectVariableEnum.const_688,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_761:
      ...
      override public function method_2(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1310,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1249,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1207,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_189)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_156 || _loc13_ == RoomPlaneData.const_290)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
