   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(param1 is RoomObjectAvatarPostureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_377,_loc3_.postureType);
            return;
         }
         if(param1 is RoomObjectAvatarUpdateMessage)
         {
            _loc4_ = param1 as RoomObjectAvatarUpdateMessage;
            _loc2_.setNumber(RoomObjectVariableEnum.const_305,_loc4_.dirHead);
            return;
         }
         if(param1 is RoomObjectAvatarChatUpdateMessage)
         {
            ...
            var_1019 = getTimer() + _loc5_.numberOfWords * 1000;
            return;
         }
         ...
         if(param1 is RoomObjectAvatarSleepUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_446,Number(_loc8_.isSleeping));
            return;
         }
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_857,Number(getTimer()));
            _loc2_.setNumber(RoomObjectVariableEnum.const_935,Number(_loc10_.gainedExperience));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_1208,_loc11_.race);
            return;
         }
      }
      ...
      override public function method_2(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(param1.type)
         {
            case MouseEvent.CLICK:
               ...
               if(eventDispatcher != null)
               {
                  _loc8_ = new RoomObjectMouseEvent(RoomObjectMouseEvent.const_246,_loc6_,_loc7_);
