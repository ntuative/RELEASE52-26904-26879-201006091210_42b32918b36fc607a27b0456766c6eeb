package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurniturePushableLogic extends FurnitureMultiStateLogic
   {
      ...
      private static const const_800:int = 1;
      
      private static const const_1114:int = 0;
       
      
      private var var_1537:Vector3d = null;
      
      public function FurniturePushableLogic()
      {
         super();
         moveUpdateInterval = const_934;
         var_1537 = new Vector3d();
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(_loc3_.state > 0)
            {
               moveUpdateInterval = const_934 / _loc3_.state;
            }
            else
            {
      ...
      override public function update(param1:int) : void
      {
         if(object != null)
         {
            var_1537.assign(object.getLocation());
            super.update(param1);
            if(Vector3d.dif(object.getLocation(),var_1537).length > 0)
            {
               if(object.getState(0) != const_800)
               {
                  object.setState(const_800,0);
               }
            }
            else
            {
               object.setState(const_1114,0);
            }
         }
      }
   }
