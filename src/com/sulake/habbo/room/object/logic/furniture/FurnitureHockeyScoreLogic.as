      ...
      override public function method_2(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(param1.type)
         {
            case MouseEvent.DOUBLE_CLICK:
               ...
               {
                  case "off":
                     _loc6_ = new RoomObjectStateChangeEvent(RoomObjectStateChangeEvent.const_181,_loc3_,_loc4_,0);
               }
               break;
            case MouseEvent.CLICK:
               ...
               {
                  case "inc":
                     _loc6_ = new RoomObjectStateChangeEvent(RoomObjectStateChangeEvent.const_181,_loc3_,_loc4_,2);
                     break;
                  case "dec":
                     _loc6_ = new RoomObjectStateChangeEvent(RoomObjectStateChangeEvent.const_181,_loc3_,_loc4_,1);
               }
         }
