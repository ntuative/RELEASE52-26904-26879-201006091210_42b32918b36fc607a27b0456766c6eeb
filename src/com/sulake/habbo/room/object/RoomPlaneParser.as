package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_769:Number = 0.0;
      
      private var var_344:int = 0;
      
      private var var_341:int = 0;
      
      private var var_1189:Number = 0.0;
      ...
      private var var_823:Number = 0.0;
      ...
      public function getPlaneType(param1:int) : int
      {
         ...
         {
            return RoomPlaneData.const_919;
         }
      ...
      private function addWall(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Boolean, param6:Boolean, param7:Boolean) : void
      {
         ...
         addPlane(RoomPlaneData.const_290,param1,param2,param3,[param4]);
         var _loc9_:Vector3d = Vector3d.crossProduct(param2,param3);
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -var_823);
         ...
         if(param6)
         {
            ...
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,var_823 / param2.length);
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         var_769 = getFloorHeight(var_104);
         if(!param1)
         {
            createWallPlanes();
         }
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < _width && param2 >= 0 && param2 < _height)
         {
            ...
            {
               if(param1 == var_341 || param1 == var_343)
               {
                  _loc5_ = false;
                  _loc6_ = var_344;
               ...
               if(param2 == var_344 || param2 == var_342)
               {
                  _loc7_ = false;
                  _loc8_ = var_341;
      ...
      {
         var _loc12_:RoomPlaneData = addPlane(RoomPlaneData.const_189,param1,param2,param3);
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_189,_loc13_,new Vector3d(0,0,-_floorThickness),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc14_ = addPlane(RoomPlaneData.const_189,_loc13_,new Vector3d(0,0,-_floorThickness),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_189,_loc13_,new Vector3d(0,0,-_floorThickness),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc15_ = addPlane(RoomPlaneData.const_189,_loc13_,new Vector3d(0,0,-_floorThickness),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
