package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_1048[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_1046[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_1048 = new Array();
         var_1048.push(Math.random() * _loc2_ * 1.5);
         var_1048.push(Math.random() * _loc2_ * 1.5);
         var_1047 = new Array();
         var_1047.push(1);
         var_1047.push(-1);
         var_1045 = new Array();
         var_1045.push(const_1100);
         var_1045.push(const_1099);
         var_1046 = new Array();
         var_1046.push(getRandomAmplitudeFactor());
         var_1046.push(getRandomAmplitudeFactor());
      }
