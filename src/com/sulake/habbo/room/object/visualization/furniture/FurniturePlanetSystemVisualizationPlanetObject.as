package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1097:Number = 30;
      ...
      {
         var_721 = new Vector3d(0,0,0);
         _children = new Array();
         super();
         _name = param1;
         _index = param2;
         var_1387 = param3;
         var_1984 = param4 * 0 * 2 / 360;
      ...
      {
         var _loc3_:Number = var_1387 * Math.cos(var_872 + var_1519);
         var _loc4_:Number = var_1387 * Math.sin(var_872 + var_1519);
         var _loc5_:Number = _height;
         var_721.x = (_loc3_ - _loc4_) * (param2 / 2);
         var_721.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - _height * (param2 / 2);
         var_721.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            var_721.add(param1);
         }
