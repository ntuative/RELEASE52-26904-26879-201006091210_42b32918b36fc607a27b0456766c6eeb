package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1439:Number = Math.sqrt(0.5);
       
      
      protected var _direction:int;
      
      protected var var_2355:int = -1;
      ...
      protected var var_1609:String = null;
      ...
      protected var var_2341:Number = NaN;
      ...
      protected function getSpriteAssetName(param1:int, param2:Number) : String
      {
         ...
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            var_601[param1] = _loc3_;
            var_600[param1] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      protected function updateSprites(param1:int, param2:Number) : void
      {
         ...
         var _loc4_:Boolean = false;
         if(var_1609 != null && var_1609.indexOf("http") == 0)
         {
            _loc4_ = true;
         }
            ...
            if(_loc7_ != null)
            {
               ...
               if(_loc8_ != null && _loc8_.asset != null)
               {
                  ...
                  if(_loc5_ < spriteCount - 1)
                  {
                     ...
                     _loc7_.color = getSpriteColor(_loc5_,var_2355,param1);
      ...
      {
         var _loc3_:int = 0;
         if(var_2024 != param1 || var_2026 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
               var_601[_loc3_] = "";
               var_600[_loc3_] = false;
               _loc3_--;
            }
            var_2024 = param1;
            var_2026 = param2;
      ...
      {
         var _loc3_:int = 0;
         if(var_2025 != param1 || var_2023 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2355 = _loc3_.getNumber(RoomObjectVariableEnum.const_233);
            ...
            var_1609 = _loc3_.getString(RoomObjectVariableEnum.const_348);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_293 != _loc3_.getUpdateID() || param1 != var_151 || param2 != var_2341)
         {
