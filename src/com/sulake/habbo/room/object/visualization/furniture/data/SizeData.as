package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      private var var_1207:int = 360;
      
      private var var_1814:int = 0;
      
      private var var_702:DirectionData = null;
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + var_1207 / 2) % 360 / var_1207;
         if(var_221.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         var _loc4_:int = -1;
         var _loc5_:int = 0;
         while(_loc5_ < var_221.length)
         {
            _loc6_ = int(var_221.getKey(_loc5_)) * var_1207;
         ...
         if(_loc4_ >= 0)
         {
            return int(var_221.getKey(_loc4_));
         }
         return const_1342;
      }
      ...
      private function getDirectionData(param1:int) : DirectionData
      {
         ...
         var _loc2_:* = null;
         _loc2_ = var_221.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
      ...
      public function dispose() : void
      {
         ...
         if(var_221 != null)
         {
            ...
            {
               _loc2_ = var_221.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc7_ = int(_loc6_.@id);
            _loc8_ = _loc6_.layer;
            if(var_221.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            ...
            var_221.add(String(_loc7_),_loc3_);
            var_1208 = -1;
            var_702 = null;
            _loc5_++;
         }
