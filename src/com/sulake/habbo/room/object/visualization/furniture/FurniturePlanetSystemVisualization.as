package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_830);
      ...
      {
         if(param1 < var_621.length)
         {
            return var_621[param1].y;
         }
      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         if(var_242 != null)
         {
            ...
            {
               _loc2_ = var_242[_loc3_];
               _loc2_.update(var_621,var_2167,param1);
               _loc3_++;
            }
