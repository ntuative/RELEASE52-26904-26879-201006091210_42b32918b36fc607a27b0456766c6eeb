package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1250:int = const_360;
      ...
      public static const const_293:int = const_114;
      ...
      private var var_2080:Number = -1.0;
      ...
      private function renderRepeatBorders(param1:BitmapData, param2:Array) : int
      {
         ...
         if(false)
         {
            _loc4_ = var_375[0] as BitmapData;
            if(_loc4_ != null)
            {
               _loc6_ = _loc4_.width;
               _loc5_.push(_loc4_);
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1612 == const_114)
         {
            _loc5_ = new Rectangle(0,0,var_24.width,var_374);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_374,var_24.width,var_374);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_24 != null)
            {
               if(var_24.width == param2 && var_24.height == param3 && Vector3d.isEqual(var_592,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_374,param6,param7);
                     return param1;
                  }
                  return var_24;
               }
         ...
         var _loc8_:* = [];
         var _loc9_:int = 0;
         while(_loc9_ < var_375.length)
         {
            _loc11_ = var_375[_loc9_] as PlaneMaterialCellColumn;
            if(_loc11_ != null)
            {
      ...
      public function clearCache() : void
      {
         ...
         if(var_592 != null)
         {
            var_592.assign(new Vector3d());
         }
         var_374 = 0;
         var _loc1_:int = 0;
         while(_loc1_ < var_375.length)
         {
            _loc2_ = var_375[_loc1_] as PlaneMaterialCellColumn;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      public function createColumn(param1:int, param2:int, param3:Array, param4:int = 1) : Boolean
      {
         ...
         var _loc6_:PlaneMaterialCellColumn = var_375[param1] as PlaneMaterialCellColumn;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
         }
         var_375[param1] = _loc5_;
