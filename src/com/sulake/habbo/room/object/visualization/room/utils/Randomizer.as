package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1509:int = 16777216;
      
      public static const const_1643:int = 1;
       
      
      private var var_2433:int = 69069;
      
      private var var_1401:int = 1;
      
      private var var_2434:int = 5;
      
      private var var_1634:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1634 * param2);
      }
      ...
      {
         var _loc1_:int = var_2433 * var_1401 + var_2434;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
