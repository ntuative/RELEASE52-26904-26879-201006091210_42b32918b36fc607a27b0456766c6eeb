package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      public function HabboConfigurationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_534 = getKey("url_prefix");
         if(var_534 != null && false)
         {
            setKey("client.fatal.error.url",var_534 + "/flash_client_error");
         }
      ...
      private function onConfigurationError(param1:Event = null) : void
      {
         ...
         Core.error("Could not load external variables. HTTP status " + _loc3_ + ". Client startup failed!",true,Core.const_1391);
      }
      
      public function keyExists(param1:String) : Boolean
      {
         var _loc2_:String = var_1097[param1] as String;
         return _loc2_ != null;
      }
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         if(getKey("local.environment") == "RoomVisualizationData")
         {
            setKey("url.prefix",getKey("url.prefix.local"));
         }
         var_534 = getKey("url.prefix");
         if(false)
         {
            _loc9_ = var_534.replace("http://","");
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         if(var_1582.indexOf(param1) < 0)
         {
            var_1097[param1] = param2;
         }
      }
      ...
      private function onInitConfiguration(param1:Event = null) : void
      {
         ...
         var_895 = true;
         events.dispatchEvent(new Event(HabboConfigurationEvent.const_173));
         if(var_2129)
         {
      ...
      {
         var _loc4_:String = var_1097[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",var_534);
