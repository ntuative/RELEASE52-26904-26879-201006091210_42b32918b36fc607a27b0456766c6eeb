package com.sulake.habbo.messenger
{
   ...
   public class ConversationsTabView
   {
      ...
      public function ConversationsTabView(param1:HabboMessenger, param2:IFrameWindow)
      {
         ...
         var_809 = IWindowContainer(param2.findChildByName("conversationstab"));
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_20.findChildByName("convo_bg"));
         _loc3_.bitmap = var_125.getButtonImage("convo_bg");
      }
      ...
      public function refresh() : void
      {
         ...
         var _loc1_:Array = var_125.conversations.openConversations;
         var _loc2_:int = 0;
         while(_loc2_ < getTabCount())
         {
            refreshTabContent(_loc2_,_loc1_[var_125.conversations.startIndex + _loc2_]);
            _loc2_++;
         }
         while(true)
         {
      ...
      {
         return var_125.conversations.startIndex > 0;
      }
      
      private function refreshTabBg(param1:IWindowContainer, param2:int, param3:String) : void
      {
         var_125.refreshButton(param1,param3,true,onTabClick,param2);
      }
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            var_125.conversations.changeStartIndex(-1);
         }
         ...
         {
            _loc4_ = param2.name == HabboMessenger.const_180 ? var_125.conversations.findConversation(param2.id) : var_125.conversations.openConversations[_loc3_ + var_125.conversations.startIndex];
            if(_loc4_ == null)
            {
               return;
            }
            var_125.conversations.setSelected(_loc4_);
         }
      ...
      {
         var_125.refreshButton(param1,!!param3 ? "next" : "prev",true,null,0);
      }
      ...
      private function refreshFigure(param1:IWindowContainer, param2:String) : void
      {
         ...
         {
            _loc3_.bitmap = var_125.getAvatarFaceBitmap(param2);
            _loc3_.visible = true;
         }
      }
      ...
      {
         return var_125.conversations.openConversations.length - var_125.conversations.startIndex > getTabCount();
      }
      ...
      {
         var _loc3_:IWindowContainer = var_809.getChildAt(param1) as IWindowContainer;
         hideChildren(_loc3_);
      ...
      private function refreshTabContent(param1:int, param2:Conversation) : Boolean
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc3_ = IWindowContainer(var_125.getXmlWindow("tab_entry"));
            _loc3_.y = 1;
            var_809.addChild(_loc3_);
         }
         hideChildren(_loc3_);
         if(param2 == null)
         {
