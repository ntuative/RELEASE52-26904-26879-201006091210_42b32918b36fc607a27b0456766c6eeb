package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger
   {
      ...
      private var var_575:Conversations;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_295:MessengerView;
      ...
      {
         var _loc2_:Conversation = var_575.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         else
         {
            ...
            var_575.setSelected(_loc2_);
            var_295.openMessenger();
            var_295.refresh(true);
         }
      }
      ...
      private function getPageParam(param1:String) : String
      {
         ...
         if(param1 == "url.prefix")
         {
            ...
            _loc2_ = var_128.getKey("url.prefix",_loc2_);
      ...
      {
         var_575.addMessageAndUpdateView(param1);
         if(!var_295.isMessengerOpen())
         {
      ...
      {
         var_575 = new Conversations(new ConversationsDeps(this));
         var_295 = new MessengerView(this);
      ...
      {
         var_575.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      {
         var_575.setFollowingAllowedAndUpdateView(param1,param2);
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_956,_loc2_.userId,getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
         var_575.addMessageAndUpdateView(_loc3_);
      }
