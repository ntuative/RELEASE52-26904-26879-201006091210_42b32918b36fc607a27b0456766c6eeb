package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private var var_1515:IContainerButtonWindow;
      
      private var var_502:Conversation;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_125 = param1;
         var_1515 = initButton("follow_friend",onFollowButtonClick,param2);
         var_51 = IItemListWindow(param2.findChildByName("msg_list"));
         var_1943 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      {
         if(param1 == Message.const_552)
         {
            return 4285887861;
         }
         if(param1 == Message.const_575)
         {
            return 4285887861;
         }
         return 4278190080;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_677 || param3.type == Message.const_670 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_502.messages.length - const_787);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_502.messages.length)
         {
            refreshEntry(true,_loc1_,var_502.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      public function refresh() : void
      {
         ...
         if(var_502 == null || _loc1_.id != var_502.id)
         {
            var_502 = _loc1_;
            refreshList();
            afterResize();
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_125.send(new FollowFriendMessageComposer(var_502.id));
      }
