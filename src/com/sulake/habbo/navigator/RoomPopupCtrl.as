package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      private var var_2161:RoomThumbnailRenderer;
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_2161 = new RoomThumbnailRenderer(param1);
         var_864 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_183,var_118.ownerName);
         var _loc1_:ITextWindow = ITextWindow(var_183.findChildByName("roomowner"));
         if(true)
         {
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_183.findChildByName("extra_cont"));
         Util.hideChildren(_loc1_);
         var_864.refreshTags(_loc1_,var_118.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_2161.refreshThumbnail(_loc1_,var_118.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         if(var_183 == null)
         {
            var_183 = IWindowContainer(param1.findChildByName("details_container"));
         }
         var_183.visible = true;
         Util.hideChildren(var_183);
         refreshRoomName(var_183,var_118);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_183,!true ? getEventCtg(var_118.categoryId) : getRoomCtg(var_118.categoryId));
         refreshRoomDesc(var_183,var_118);
         refreshExtraCont();
         refreshInfo(var_183,"trading_allowed",var_118.allowTrading);
         refreshInfo(var_183,"doormode_doorbell",false);
         refreshInfo(var_183,"doormode_password",false);
         Util.moveChildrenToColumn(var_183,["roomname","roomctg_cont","roomowner_cont","roomdesc","extra_cont","doormode_doorbell","doormode_password","trading_allowed"],0,0);
         var_183.height = Util.getLowestPoint(var_183);
      }
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_226,Tabs.const_212,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
