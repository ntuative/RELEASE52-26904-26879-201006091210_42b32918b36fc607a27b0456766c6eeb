package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboNavigator)
      {
         ...
         _loc2_.addHabboConnectionMessageEvent(new OfficialRoomsEvent(method_8));
      ...
      private function onRoomSettingsSaved(param1:IMessageEvent) : void
      {
         ...
         _navigator.mainViewCtrl.reloadRoomList(Tabs.const_249);
      }
      ...
      private function onCantConnect(param1:IMessageEvent) : void
      {
         ...
         {
            case CantConnectMessageParser.const_1378:
            ...
            case CantConnectMessageParser.const_1303:
               ...
               _loc3_.show();
               break;
            case CantConnectMessageParser.const_1239:
      ...
      private function onCanCreateRoom(param1:IMessageEvent) : void
      {
         ...
         Logger.log("Can create room: " + _loc2_.method_3 + ", " + _loc2_.roomLimit);
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         {
            if(_loc2_.data.doorMode == RoomSettingsData.const_165 && _navigator.sessionData.userName != _loc2_.data.ownerName)
            {
      ...
      private function onThumbnailUpdated(param1:IMessageEvent) : void
      {
         ...
         Logger.log("THUMBNAIL UPDATED: " + _loc2_.method_3);
