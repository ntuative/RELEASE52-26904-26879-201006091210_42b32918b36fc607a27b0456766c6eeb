package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_973:RoomCreateViewCtrl;
      ...
      private var var_656:RoomInfoViewCtrl;
      
      private var _catalog:IHabboCatalog;
      
      private var var_419:Tabs;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_289 = new MainViewCtrl(this);
         var_656 = new RoomInfoViewCtrl(this);
         var_973 = new RoomCreateViewCtrl(this);
         var_2161 = new RoomThumbnailRenderer(this);
         var_1089 = new GuestRoomPasswordInput(this);
         _doorbell = new GuestRoomDoorbell(this);
         var_419 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_289.startSearch(Tabs.const_226,Tabs.const_311,param1);
         var_289.mainWindow.activate();
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = var_128.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      public function showOwnRooms() : void
      {
         ...
         var_289.startSearch(Tabs.const_276,Tabs.const_249);
         var_419.getTab(Tabs.const_276).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_289.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
