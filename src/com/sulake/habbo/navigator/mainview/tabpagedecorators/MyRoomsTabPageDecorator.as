package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_510:IDropMenuWindow;
      
      private var var_2448:IWindowContainer;
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         ...
         if(param1 == 3)
         {
            return Tabs.const_582;
         }
         if(param1 == 4)
         {
            return Tabs.const_682;
         }
         return Tabs.const_249;
      }
      
      private function startSearch() : void
      {
         var _loc1_:int = var_510 == null ? 0 : int(var_510.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         _navigator.mainViewCtrl.startSearch(Tabs.const_276,getSearchTypeForIndex(_loc1_));
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_510 == null)
         {
            var_510 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_510.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
