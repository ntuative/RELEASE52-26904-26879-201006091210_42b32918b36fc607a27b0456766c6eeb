package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_893:RoomLayout;
      ...
      private var var_1069:TextFieldManager;
      
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_523 = new Timer(100);
         var_523.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_40 = new Array();
         ...
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_61,80,"g"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_61,74,"h"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_61,416,"o"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_61,352,"p"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_61,304,"q"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_61,336,"r"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_61,748,"u"));
         var_40.push(new RoomLayout(HabboClubLevelEnum.const_61,438,"v"));
      ...
      private function prepare() : void
      {
         ...
         var_1069 = new TextFieldManager(_navigator,ITextFieldWindow(var_20.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      public function dispose() : void
      {
         if(var_523)
         {
            var_523.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_523.reset();
            var_523 = null;
         }
      }
      ...
      {
         var_1069.goBackToInitialState();
         var_1069.input.textBackgroundColor = 4294967295;
         var_893 = var_40[0];
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_57,HabboWindowStyle.const_43,HabboWindowParam.const_75,new Rectangle(0,0,100,300)));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1069.getText();
      ...
      {
         var _loc1_:Boolean = var_1069.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_893.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1288 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1288 = true;
            _loc3_.y = 1;
