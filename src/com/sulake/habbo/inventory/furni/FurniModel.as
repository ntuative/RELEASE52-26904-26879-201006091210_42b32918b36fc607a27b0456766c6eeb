package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         _assets = param5;
         _roomEngine = param6;
         _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_230,onObjectPlaced);
         var_491 = new Timer(const_1089,1);
         var_491.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return var_29.getSubCategoryViewId() == InventorySubCategory.const_260;
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_400.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_400.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(_roomEngine != null)
            {
               if(false)
               {
                  _roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_230,onObjectPlaced);
               }
               _roomEngine = null;
            }
            _communication = null;
            ...
            if(var_491 != null)
            {
               var_491.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_491.stop();
               var_491 = null;
            }
            if(var_129 != null)
      ...
      private function requestSelectedFurniToMover(param1:IItem) : void
      {
         ...
         if(param1.category == FurniCategory.const_177)
         {
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(var_704 == null)
         {
            var_704 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_704.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_260:
               ...
               break;
            case InventorySubCategory.const_1001:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      {
         var_29.checkCategoryInitilization(InventoryCategory.const_330);
         ...
         if(param1 == InventoryCategory.const_78 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_46:
                  ...
                  break;
               case const_359:
                  var_29.toggleInventoryPage(InventoryCategory.const_146);
            }
         }
      }
      ...
      {
         if(var_839 && param1.type == RoomEngineObjectEvent.const_230)
         {
            var_29.showView();
            var_839 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_357 || _loc3_.category == FurniCategory.const_312 || _loc3_.category == FurniCategory.const_343)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_400.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_400 = new Map();
         var_400.add(const_45,new Array());
         var_400.add(const_46,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
