package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1747:int = 2;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboConfigurationManager)
      {
         ...
         _roomEngine = param5;
         var_508 = new Map();
         var_508.add(FurniModel.const_45,new FurniGridView(_model,FurniModel.const_45,_windowManager,_assetLibrary,_roomEngine));
         var_508.add(FurniModel.const_46,new FurniGridView(_model,FurniModel.const_46,_windowManager,_assetLibrary,_roomEngine));
         ...
         else if(param1.type == WindowEvent.const_62)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  switchCategory(FurniModel.const_359);
            }
         }
      }
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         var _loc4_:FurniGridView = var_508.getValue(var_509);
         if(_loc4_ != null)
         {
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = _model.getGroupItemInIndex(_loc3_,var_509);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            {
               if(_loc5_.category == FurniCategory.const_177)
               {
         ...
         if(_loc12_)
         {
            if(_loc1_ && var_777 && false && _loc5_.sellable)
            {
               _loc12_.enable();
            }
            else
