package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IAvatarImageListener
   {
      ...
      private var var_313:PetsGridItem;
      ...
      {
         if(var_604 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_604.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_313 != null)
         {
            var_313.setSelected(false);
         }
         var_313 = param1;
         if(var_313 != null)
         {
            var_313.setSelected(true);
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_313.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_604.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_604.getValue(param1.id) != null)
         {
            return;
         }
