package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1218 && param1.type == RoomEngineObjectEvent.const_230)
         {
            var_29.showView();
            var_1218 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            var_1218 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_40,RoomObjectTypeEnum.const_317,_loc3_.figure);
            var_29.closeView();
            return;
         }
      ...
      {
         if(var_1031.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }
