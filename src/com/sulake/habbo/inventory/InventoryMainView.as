package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(var_1356);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         if(param1.type == HabboToolbarEvent.const_60)
         {
            ...
            else if(var_766 == InventoryCategory.const_78)
            {
      ...
      private function setSubViewToCategory(param1:String) : void
      {
         ...
         if(_toolbar != null)
         {
            _toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_558,HabboToolbarIconEnum.INVENTORY,var_15 as IWindowContainer));
         }
      }
      ...
      public function showInventory() : void
      {
         ...
         var_29.inventoryViewOpened(var_765);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != var_766 || !var_29.isInventoryCategoryInit(param1))
            {
               setViewToCategory(param1);
            }
            if(_toolbar != null && var_926)
