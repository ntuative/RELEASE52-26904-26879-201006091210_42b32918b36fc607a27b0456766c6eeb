package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_832:IRoomSession;
      ...
      override public function dispose() : void
      {
         ...
         if(var_18 != null)
         {
            var_18.events.removeEventListener(RoomSessionEvent.const_102,roomSessionEventHandler);
            var_18.events.removeEventListener(RoomSessionEvent.const_112,roomSessionEventHandler);
            var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_394,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_112:
               var_832 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_394:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_47.getValue(InventoryCategory.const_548));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_47.getValue(InventoryCategory.const_78));
      }
      ...
      {
         var_102.clubPeriods = param1;
         var_102.clubDays = param2;
         var_102.clubHasEverBeenMember = param3;
         var_102.isVIP = param4;
      ...
      {
         return PetsModel(var_47.getValue(InventoryCategory.const_146));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_888));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1725);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_47.getValue(InventoryCategory.const_361));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_833.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_833.splice(_loc3_,1);
            }
         }
      }
      ...
      public function get clubLevel() : int
      {
         ...
         return HabboClubLevelEnum.const_61;
      }
      ...
      {
         return TradingModel(var_47.getValue(InventorySubCategory.const_260));
      }
      ...
      {
         return var_102.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_47.getValue(InventoryCategory.const_330) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1020 = new IncomingMessages(this);
      ...
      {
         return var_102.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_102.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_47.getValue(InventoryCategory.const_273));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_102,roomSessionEventHandler);
         var_18.events.addEventListener(RoomSessionEvent.const_112,roomSessionEventHandler);
         var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_394,roomSessionEventHandler);
         ...
         var_47.add(InventoryCategory.const_330,_loc3_);
         ...
         var_47.add(InventoryCategory.const_146,_loc10_);
