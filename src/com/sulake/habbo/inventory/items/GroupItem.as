package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_1518:Number;
      
      protected var _type:int;
      
      protected var _roomEngine:IRoomEngine;
      
      protected var var_2360:BitmapData;
      ...
      protected var var_465:int = 0;
      
      protected var var_1446:String;
      
      private const const_1737:int = 8947848;
      ...
      private const const_1463:Number = 0.2;
      
      protected var var_1440:Boolean;
      
      private const const_1464:Number = 1;
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1518));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1446);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1463;
               _loc1_.blend = const_1463;
            }
            else
            {
               _window.blend = const_1464;
               _loc1_.blend = const_1464;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1440 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2360;
               _loc5_.visible = true;
            }
            else
            {
