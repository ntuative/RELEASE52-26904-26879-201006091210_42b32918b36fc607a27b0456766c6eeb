package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_890.length)
         {
            if(var_890[_loc2_] == param1)
            {
               var_890.splice(_loc2_,1);
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         {
            _loc2_ = var_274[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case 0:
               ...
               while(_loc3_ < var_274.length)
               {
                  if((var_274[_loc3_] as Badge).isInUse == false)
                  {
                     _loc2_.push(var_274[_loc3_]);
                  }
                  _loc3_++;
               }
               return _loc2_;
      ...
      {
         if(param1 == InventoryCategory.const_273 && false)
         {
