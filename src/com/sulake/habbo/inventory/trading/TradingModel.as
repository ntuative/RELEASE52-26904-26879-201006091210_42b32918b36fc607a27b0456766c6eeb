package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_338:uint = 2;
      
      public static const const_411:uint = 4;
      ...
      public static const const_1317:uint = 9;
      
      public static const const_219:uint = 5;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_505 = false;
         var_723 = false;
         var_48.updateItemList(var_722);
         var_48.updateItemList(var_1250);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_48.alertPopup(TradingView.const_921);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == var_722)
            {
               var_505 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               var_723 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            var_48.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != var_722)
            {
               var_48.alertPopup(TradingView.const_905);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + var_36 + " NEW STATE: " + param1 + " OWN: " + var_505 + " OTHER: " + var_723);
         ...
         {
            case const_164:
               if(param1 == const_176 || param1 == const_219)
               {
                  var_36 = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         {
            _loc2_ = var_227.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         else
         {
            ...
            if(param3 == FurniCategory.const_177)
            {
               _loc6_ = String(param2) + "poster" + param5;
            }
            if(var_227.getValue(_loc6_) == null)
            {
               return false;
            }
            _communication.getHabboMainConnection(null).send(new AddItemToTradeComposer(param1));
      ...
      public function close() : void
      {
         if(var_657)
         {
            if(var_36 != const_164 && var_36 != const_219)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_164;
            var_11.toggleInventorySubPage(InventorySubCategory.const_1001);
            var_657 = false;
         }
         var_48.setMinimized(false);
      }
