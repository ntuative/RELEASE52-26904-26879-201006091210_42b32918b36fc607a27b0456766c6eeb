package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_805:uint = 4284532064;
      
      private static const const_806:uint = 2577770;
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_177)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_944)
            {
            ...
            var_362.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_510);
            var_362.show();
         }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1544 == null)
         {
            var_1544 = createMinimizedWindow();
         }
         if(!var_2049)
         {
            return var_65;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_65)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_805) : uint(const_806);
            }
