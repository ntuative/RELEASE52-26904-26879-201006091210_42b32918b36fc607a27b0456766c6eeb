package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function makeOffer(param1:int) : void
      {
         ...
         var _loc3_:int = var_240 is FloorItem ? 1 : 2;
         _loc2_.send(new MakeOfferMessageComposer(param1,_loc3_,var_240.ref));
         releaseItem();
      }
      ...
      public function getItemStats() : void
      {
         ...
         var _loc2_:int = var_240 is FloorItem ? 1 : 2;
         var_1861 = _loc2_;
         var_1864 = var_240.type;
         _loc1_.send(new GetMarketplaceItemStatsComposer(_loc2_,var_240.type));
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_1647,var_1648);
         }
      }
      ...
      {
         if(param1 != var_1861 || param2 != var_1864)
         {
            return;
         }
         if(!_view)
         ...
         _view.updateAveragePrice(param3,var_1857);
      }
      ...
      {
         if(var_29 != null && false && var_240 != null)
         {
            var_29.furniModel.removeLockFrom(var_240.id);
            var_240 = null;
         }
      }
