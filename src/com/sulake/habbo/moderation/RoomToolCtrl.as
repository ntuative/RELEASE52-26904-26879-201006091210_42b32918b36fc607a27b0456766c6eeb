package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_538,_data.flatId),var_53,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_434);
         if(param1.flatId != var_434)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_434);
            return;
         }
         _data = param1;
         populate();
      ...
      private function act(param1:Boolean) : void
      {
         ...
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1318,_loc2_,var_455.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1025.isSelected,var_1024.isSelected,var_703.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         ...
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1371);
      }
      ...
      public function populate() : void
      {
         ...
         var_703 = ICheckBoxWindow(var_53.findChildByName("kick_check"));
         var_1025 = ICheckBoxWindow(var_53.findChildByName("lock_check"));
         var_1024 = ICheckBoxWindow(var_53.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         _main.connection.send(new GetModeratorRoomInfoMessageComposer(var_434));
         Logger.log("BEGINNING TO SHOW: " + var_434);
      }
   }
}
