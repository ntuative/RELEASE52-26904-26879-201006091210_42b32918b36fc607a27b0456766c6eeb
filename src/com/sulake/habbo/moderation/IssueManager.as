package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_949:String = "issue_bundle_picked";
      ...
      private var var_629:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_140 = new Map();
         var_942 = new Map();
         var_629 = new IssueBrowser(this,var_59.windowManager,var_59.assets);
         var_774 = [];
         var_943 = [];
         var_1113 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_1113.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
         ...
         for each(_loc4_ in var_140)
         {
            switch(param1)
            {
               case const_1005:
                  ...
                  break;
               case const_733:
                  if(_loc4_.state == IssueMessageData.const_441 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function pickBundle(param1:int) : void
      {
         ...
         var_774 = var_774.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var_165.remove(param1.issueId);
         var_165.add(param1.issueId,param1);
         var _loc2_:int = int(var_942.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  var_942.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1297)
         {
            var_165.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_140)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_942.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_942.add(param1.issueId,_loc2_);
         ...
         if(var_774.indexOf(param1.issueId) != -1)
         {
         ...
         if(param1.state == IssueMessageData.const_158)
         {
            ...
            _loc8_ = var_943.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var_1113.remove(param1);
         var_1113.add(param1,_loc3_);
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_441 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      {
         var _loc2_:* = var_1113.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_629 == null || !var_629.isOpen())
         {
            var_59.soundManager.playSound(HabboSoundTypesEnum.const_948);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_942.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_140.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_441 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }
