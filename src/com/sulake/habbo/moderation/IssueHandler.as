package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_59.issueManager.releaseBundle(var_120.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var_1100 = new UserInfoCtrl(_window,var_59,_loc3_.message);
         var_438.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_120.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_1100.load(_loc4_,var_120.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_59.issueManager.closeBundle(var_120.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_59.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_59,WindowTracker.const_1016,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_59 != null && false && var_120 != null)
         {
            var_59.issueManager.removeHandler(var_120.id);
         }
         this.dispose();
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_59.issueManager.closeBundle(var_120.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_59.issueManager.closeBundle(var_120.id,3);
         checkAutoHandling();
         dispose();
      }
