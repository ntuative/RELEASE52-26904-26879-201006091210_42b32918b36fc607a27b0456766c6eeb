package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1594:IIssueBrowserView;
      
      private const const_1743:String = "open_issues";
      ...
      private var var_1595:IIssueBrowserView;
      
      private const const_1748:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1745:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_243:ITabContextWindow;
      
      private var var_1593:PickedIssuesView;
      
      private var var_373:IIssueBrowserView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(_window == null)
         {
            ...
            var_243 = _window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < var_243.numTabItems)
            {
               _loc5_ = var_243.getTabItemAt(_loc6_);
         ...
         var _loc1_:ISelectableWindow = var_243.selector.getSelectableByName("open_issues");
         var_243.selector.setSelected(_loc1_);
      }
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_373.view.width = var_243.container.width;
         var_373.view.height = var_243.container.height;
         var_373.visible = true;
         var_373.update();
      }
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1745:
               if(var_1595 == null)
               {
                  var_1595 = new MyIssuesView(issueManager,this,var_243.container);
               }
               return var_1595;
            case const_1743:
               if(var_1594 == null)
               {
                  var_1594 = new OpenIssuesView(issueManager,this,var_243.container);
               }
               return var_1594;
            case const_1744:
               if(var_1593 == null)
               {
                  var_1593 = new PickedIssuesView(issueManager,this,var_243.container);
               }
               return var_1593;
            default:
               return null;
