package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         _id = param1;
         var_165 = new Map();
         var_165.add(param2.issueId,param2);
         var_36 = param2.state;
         var_2227 = param2.pickerUserId;
         var_2319 = param2.pickerUserName;
         var_1037 = param2.reportedUserId;
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         ...
         var _loc1_:IssueMessageData = var_165.getWithIndex(0);
         var _loc3_:int = 1;
         while(_loc3_ < var_165.length)
         {
            _loc2_ = var_165.getWithIndex(_loc3_);
      ...
      {
         return var_165.remove(param1) as IssueMessageData;
      }
