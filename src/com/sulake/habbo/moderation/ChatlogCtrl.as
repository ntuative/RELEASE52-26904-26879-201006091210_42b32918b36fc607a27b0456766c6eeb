package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1568:IMessageComposer;
      ...
      private var var_1342:Dictionary;
      ...
      {
         var_918 = IWindowContainer(_main.getXmlWindow("chatlog_roomheader"));
         var_919 = IWindowContainer(_main.getXmlWindow("chatlog_chatline"));
         ...
         _main.connection.send(var_1568);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_918.clone());
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_919.clone());
         _loc4_.color = var_1342[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
