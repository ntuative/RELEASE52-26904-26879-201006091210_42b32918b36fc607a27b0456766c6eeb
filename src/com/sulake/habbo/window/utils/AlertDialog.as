package com.sulake.habbo.window.utils
{
   ...
   public class AlertDialog implements IAlertDialog, INotify
   {
      ...
      private static const const_1071:String = "_alert_button_list";
      
      private static const const_772:String = "_alert_button_cancel";
      
      private static const const_651:String = "_alert_button_ok";
      
      private static const const_1347:String = "_alert_text_summary";
      ...
      public function AlertDialog(param1:IHabboWindowManager, param2:XML, param3:String, param4:String, param5:uint, param6:Function)
      {
         ...
         var _loc7_:IItemListWindow = _window.findChildByName(const_1071) as IItemListWindow;
         if(_loc7_)
         {
            if(!(param5 & 0))
            {
               _loc8_ = _loc7_.getListItemByName(const_651);
               _loc8_.dispose();
            }
            if(!(param5 & 0))
            {
      ...
      public function set summary(param1:String) : void
      {
         ...
         if(_window)
         {
            ITextWindow(_window.findChildByTag("DESCRIPTION")).text = var_1190;
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "_alert_button_ok":
                  if(var_188 != null)
                  {
                     var_188(this,new WindowEvent(WindowEvent.const_167,null,null));
                  }
                  break;
               case "header_button_close":
                  if(var_188 != null)
                  {
                     var_188(this,new WindowEvent(WindowEvent.const_669,null,null));
                  }
            }
         }
      }
      ...
      public function getButtonCaption(param1:int) : ICaption
      {
         ...
         if(!_disposed)
         {
            switch(param1)
            {
               case HabboAlertDialogFlag.const_651:
                  _loc2_ = _window.findChildByName(const_651) as IInteractiveWindow;
                  break;
