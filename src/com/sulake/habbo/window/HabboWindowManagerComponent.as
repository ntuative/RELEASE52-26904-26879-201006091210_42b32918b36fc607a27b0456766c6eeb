package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_376:uint = 3;
      ...
      private var var_1423:IEventDispatcher;
      
      private var var_2466:uint = 0;
      
      private var var_1426:ProfilerAgentTask;
      
      private var var_1425:ProfilerOutput;
      
      private var var_800:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         _instance = this;
         var_1423 = Component(param1).events;
         var_458 = new Array();
      ...
      {
         return var_249[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_249[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_735 = new SkinContainer(_loc3_.content as XML,assets);
         var_800 = new WindowRenderer(var_735);
         var_249 = new Array(const_376);
         var _loc5_:int = 0;
         while(_loc5_ < const_376)
         {
            _loc4_ = new WindowContext("layer_" + _loc5_,var_800,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_249[_loc5_] = _loc4_;
            _loc5_++;
         }
         var_229 = var_249[const_1175];
         registerUpdateReceiver(this,0);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_229.getMouseCursor().defineCustomCursorType(MouseCursorType.ARROW_LINK,_loc6_);
         _loc6_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_229.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1228,_loc6_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_249[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_249.pop()).dispose();
            }
            var_249 = null;
            while(false)
            {
      ...
      {
         return var_249[param1].getDesktopWindow().getChildAt(var_229.getDesktopWindow().numChildren - 1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_458[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_458[0][param1] as XML : _loc4_;
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1425 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1425 = new ProfilerOutput(_loc3_,this,var_800);
               var_1424 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1424);
               var_1426 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1426);
               var_1144 = true;
            }
         }
      }
      ...
      {
         return var_229.getWindowParser().windowToXMLString(param1);
      }
      
      public function getDefaultsByTypeAndStyle(param1:uint, param2:uint) : DefaultAttStruct
      {
         return var_735.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_977.length > 0)
         {
            var_1423.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_376 - 1;
            while(_loc2_ >= 0)
            {
               var_249[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_1144)
         ...
         var_1423.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_376)
         {
            var_249[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_1144)
         {
         ...
         if(WindowContext.var_977.length > 0)
         {
            WindowContext.var_977.flush();
         }
         if(WindowContext.var_1431.length > 0)
         {
            WindowContext.var_1431.flush();
         }
         var_1423.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      {
         return var_229.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1211,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1201,param2.name + ": " + param2.toString());
            }
         }
      }
   }
