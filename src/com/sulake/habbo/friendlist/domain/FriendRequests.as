package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendRequests
   {
      ...
      private var var_389:IFriendRequestsDeps;
      ...
      public function acceptFailed(param1:String) : void
      {
         ...
         _loc2_.state = FriendRequest.const_913;
         var_389.view.refreshRequestEntry(_loc2_);
      }
      ...
      public function refreshShading() : void
      {
         ...
         {
            _loc1_ = !_loc1_;
            var_389.view.refreshShading(_loc2_,_loc1_);
         }
      }
      ...
      {
         var_238.push(param1);
         var_389.view.addRequest(param1);
      }
      ...
      public function clearAndUpdateView(param1:Boolean) : void
      {
         ...
         for each(_loc4_ in _loc2_)
         {
            ...
            if(false)
            {
               var_389.view.removeRequest(_loc4_);
            }
            _loc4_.dispose();
         }
         refreshShading();
