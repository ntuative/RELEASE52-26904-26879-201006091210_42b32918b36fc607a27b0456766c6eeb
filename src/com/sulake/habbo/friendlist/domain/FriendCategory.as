package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_352:int = 100;
      ...
      {
         return Math.ceil(this.var_224.length / const_352);
      }
      ...
      {
         if(this.var_865 >= this.getPageCount())
         {
            this.var_865 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_865 + 1) * const_352,this.var_224.length);
      }
