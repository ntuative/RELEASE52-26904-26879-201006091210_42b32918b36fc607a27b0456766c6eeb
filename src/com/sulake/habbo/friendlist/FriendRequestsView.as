package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1450:String = "no_reqs_info";
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_346 && _loc4_.state != FriendRequest.const_310)
            {
               ...
               {
                  _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_59,_loc4_.requestId));
               }
            }
         }
      ...
      {
         var_1451 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1452 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1452.procedure = onDismissAllButtonClick;
         var_1451.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_913)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1451,_loc1_);
         setEnabled(var_1452,_loc1_);
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         if(_friendList && false)
         {
            _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_59,param1));
         }
      }
