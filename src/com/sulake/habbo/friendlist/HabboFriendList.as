package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_821:IAvatarRenderManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_419:FriendListTabs;
      ...
      private var var_1662:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_658:ISessionDataManager;
      
      private var var_380:FriendRequests;
      
      private var var_1732:int;
      
      var var_91:FriendCategories;
      
      private var var_2335:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_975:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_2335 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_91 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1662 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_380.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_380.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_419.findTab(FriendListTab.const_93).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_380 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_91.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_91.addCategory(new FriendCategory(FriendCategory.const_912,getText("friendlist.friends")));
         var_91.addCategory(new FriendCategory(FriendCategory.const_395,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_91.addFriend(new Friend(_loc4_));
         }
         var_419 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_556)
         {
            var_556 = new Timer(120000);
            var_556.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_556.start();
         }
         getBuddyRequests();
         registerListeners();
      ...
      override public function dispose() : void
      {
         ...
         {
            var_556.stop();
            var_556.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_556 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_125)
         {
            var_125.release(new IIDHabboMessenger());
            var_125 = null;
         }
         if(var_128)
         {
         ...
         if(var_821)
         {
            var_821.release(new IIDAvatarRenderManager());
            var_821 = null;
         }
         if(var_975)
         {
            var_975.release(new IIDHabboNotifications());
            var_975 = null;
         }
         if(_toolbar)
         {
         ...
         if(var_658)
         {
            var_658.release(new IIDSessionDataManager());
            var_658 = null;
         }
         super.dispose();
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_125 = param2 as IHabboMessenger;
      ...
      {
         var_91.onFriendListUpdate(param1);
      ...
      {
         var _loc1_:String = var_128.getKey("client.minimail.embed.enabled");
         return _loc1_ == "RoomVisualizationData";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_419.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1662.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_380.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_91.findFriend(param1);
      }
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         var _loc2_:int = 0;
         if(var_658.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         else if(var_658.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = 0;
         }
         if(_loc2_ > var_380.limit)
         {
            var_380.limit = _loc2_;
         }
      }
      
      public function declineFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = var_419.findTab(FriendListTab.const_93);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_821.createAvatarImage(param1,AvatarScaleType.SMALL);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_380.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_419.findTab(FriendListTab.const_93);
      ...
      {
         return var_128.getKey(param1,param1,param2);
      }
