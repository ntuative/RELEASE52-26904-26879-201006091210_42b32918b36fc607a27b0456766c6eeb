package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         var_779 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_779.procedure = onSearchInput;
         var_779.addEventListener(WindowKeyboardEvent.const_147,onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            var_51.getListItemAt(_loc1_).color = _friendList.laf.getRowShadingColor(FriendListTab.const_355,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_779.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
