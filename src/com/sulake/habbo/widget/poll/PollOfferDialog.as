package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_294:String = "POLL_OFFER_STATE_UNKNOWN";
      
      public static const const_534:String = "POLL_OFFER_STATE_CANCEL";
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  case "poll_offer_button_ok":
                     var_36 = const_1396;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_657,_id));
                     break;
                  case "poll_offer_button_cancel":
                     var_36 = const_534;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_480,_id));
