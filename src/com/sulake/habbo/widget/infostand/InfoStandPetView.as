package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1719:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1721:String = "level";
      
      private var var_107:IItemListWindow;
      
      private const const_1716:String = "energy";
      
      private var var_1187:Map;
      
      private const const_1717:String = "nutrition";
      ...
      private const const_1724:int = 158;
      
      private const const_1722:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_171:PetCommandTool;
      
      private const const_1720:uint = 11184810;
      
      private const const_1723:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_241 != null)
         {
            var_107 = var_241.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_107 == null || var_241 == null || var_64 == null)
         {
            return;
         }
         ...
         var_241.height = NaN;
         _window.width = Math.max(var_241.width,var_64.width);
      ...
      private function openTrainView() : void
      {
         if(var_171 == null)
         {
            var_171 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1187.getValue(var_568) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_171.showWindow(true);
            var_171.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1721,param1.level,param1.levelMax);
         updateStateElement(const_1723,param1.experience,param1.experienceMax);
         updateStateElement(const_1716,param1.energy,param1.energyMax);
         updateStateElement(const_1717,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_568 = param1.id;
         var_1187.remove(param1.id);
         var_1187.add(param1.id,param1);
         if(var_171 && var_171.isVisible() && param1.isOwnPet)
         {
            var_171.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_171.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(var_171 && var_171.getPetId() == var_568)
               {
                  var_171.showWindow(false);
               }
               break;
            case "btn_train":
               openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_511,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1724,const_1722,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1720);
         ...
         _loc5_.fillRect(_loc7_,const_1719);
         return _loc5_;
      }
