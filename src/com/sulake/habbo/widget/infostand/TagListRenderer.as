package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1731:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1414 != null && var_1414.indexOf(param1) != -1)
         {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_870 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_870 += param1.height + const_1730;
            return fit(param1);
         }
         param1.offset(_offsetX,var_870);
         _offsetX += param1.width + const_1731;
         return true;
      }
