package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsView implements IMeMenuView
   {
      ...
      private var var_738:MeMenuSettingsViewSlider;
      
      private var var_1563:BitmapData;
      
      private var var_1562:BitmapData;
      
      private var var_739:Number = 1.0;
      ...
      {
         var_739 = param1.volume;
         if(var_738 != null)
         {
            var_738.setValue(var_739);
         }
         setSoundsOffIcon();
         setSoundsOnIcon();
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_738 = new MeMenuSettingsViewSlider(this,_window.findChildByName("volume_container") as IWindowContainer,_widget.assets,0,1);
         setSoundsOffIcon();
         setSoundsOnIcon();
         ...
         _widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_704));
      }
      ...
      private function onButtonOut(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "sounds_off":
               if(var_739 != 0)
               {
                  setBitmapWrapperContent("sounds_off_icon",var_1564);
               }
               break;
            case "sounds_on":
               if(var_739 != 1)
               {
                  setBitmapWrapperContent("sounds_on_icon",var_1562);
               }
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         {
            setBitmapWrapperContent("sounds_on_icon",var_1563);
         }
         else
         {
            setBitmapWrapperContent("sounds_on_icon",var_1562);
