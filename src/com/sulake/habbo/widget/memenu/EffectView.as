package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_939:IWindow;
      
      private var var_941:IWindow;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_941 = _window.findChildByName("effect_hilite");
            var_941.visible = false;
         }
         var_940 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_939 = _window.findChildByName("loader_bar");
         if(var_939 != null)
         {
            var_444 = var_939.width;
            var_179.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_940 != null)
         {
            var_940.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_940.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
