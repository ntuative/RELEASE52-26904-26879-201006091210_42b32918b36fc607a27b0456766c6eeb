package com.sulake.habbo.widget.furniture.clothingchange
{
   ...
   public class ClothingChangeFurnitureWidget extends RoomWidgetBase
   {
      ...
      private static const const_785:String = "Girl";
      
      private static const const_786:String = "Boy";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_340,onUpdate);
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_1041,onUpdate);
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_358,onUpdate);
      ...
      private function onUpdate(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetClothingChangeUpdateEvent.const_340:
      ...
      {
         requestEditor(FigureData.const_79);
      }
      ...
      private function showGenderSelectionInterface(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         ...
         var_1900 = param1.objectCategory;
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_340,onUpdate);
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_1041,onUpdate);
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_358,onUpdate);
      }
      ...
      private function requestEditor(param1:String) : void
      {
         ...
         _loc5_.setParamFlag(HabboWindowParam.const_96,true);
         var_586 = _loc4_;
         var_586.offset(100,100);
         var _loc6_:IWindow = var_586.findChildByTag("close");
         if(_loc6_ != null)
         {
            _loc6_.procedure = onEditorWindowClose;
         }
         var _loc7_:* = null;
         _loc7_ = new RoomWidgetClothingChangeMessage(RoomWidgetClothingChangeMessage.const_335,param1,var_159,var_1900,_roomId,_roomCategory,_loc5_);
      ...
      private function hideEditorInterface() : void
      {
         ...
         if(var_586 != null)
         {
            _loc1_ = var_586 as IFrameWindow;
            if(_loc1_ != null)
            {
