package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = var_243.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            var_243.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_57,HabboWindowStyle.const_43,0 | 0,new Rectangle(const_1072,const_1073,2,2),null,0) as IWindowContainer;
         ...
         var_243 = ITabContextWindow(_window.findChildByName("tab_context"));
         selectTab(_widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < var_243.numTabItems)
         {
            _loc6_ = var_243.getTabItemAt(_loc2_);
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = var_243.selector.getSelected();
         return var_243.selector.getSelectableIndex(_loc1_);
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         if(var_468 != null)
         {
            var_468.setSelectedColorIndex(_selectedColorIndex);
         }
