package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1067:UserDataManager;
      ...
      {
         if(var_36 == RoomSessionEvent.const_332 && _connection != null)
         {
            var_36 = RoomSessionEvent.const_102;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1067 as IUserDataManager;
      }
