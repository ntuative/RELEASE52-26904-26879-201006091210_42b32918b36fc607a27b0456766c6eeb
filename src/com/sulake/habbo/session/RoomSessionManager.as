package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      public function gotoRoom(param1:Boolean, param2:int, param3:String = "", param4:String = "") : Boolean
      {
         ...
         var_917 = true;
         if(var_209.getValue(_loc6_) != null)
         {
         ...
         var_209.add(_loc6_,_loc7_);
         _events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_332,_loc7_));
         return true;
      }
      ...
      private function initializeManager() : void
      {
         ...
         if(initialized && var_1341)
         {
            gotoRoom(var_2145,var_2143,var_1340);
            var_1341 = false;
            var_1340 = "";
         }
      }
      ...
      {
         if(param1.state == RoomSessionEvent.const_102)
         {
            return false;
         }
         if(param1.start())
         {
            var_917 = false;
            _events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_102,param1));
      ...
      override public function dispose() : void
      {
         ...
         if(var_209)
         {
            while(false)
            {
               _loc1_ = var_209.getKey(0) as String;
               _loc2_ = var_209.remove(_loc1_) as RoomSession;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function getSession(param1:int, param2:int) : IRoomSession
      {
         ...
         return var_209.getValue(_loc3_) as IRoomSession;
      }
      ...
      public function sessionReinitialize(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var _loc6_:RoomSession = var_209.remove(_loc5_) as RoomSession;
         if(_loc6_ != null)
         {
            param4 = param2;
            _loc6_.reset(param3,param4);
            _loc5_ = getRoomIdentifier(param3,param4);
            _loc7_ = var_209.remove(_loc5_);
            if(_loc7_ != null)
            {
            }
            var_209.add(_loc5_,_loc6_);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomSession = var_209.remove(_loc3_) as RoomSession;
         if(_loc4_ != null)
         {
            _events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_112,_loc4_));
            _loc4_.dispose();
         }
      }
