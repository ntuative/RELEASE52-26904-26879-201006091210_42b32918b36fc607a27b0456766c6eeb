package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_613:Function;
      
      private var _window:IWindowContainer;
      
      private var var_754:IAssetLibrary;
      
      private var var_915:uint = 0;
      
      private var var_612:Function;
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = var_754.getAssetByName(_loc2_.assetName);
         if(param1.type == AssetLoaderEvent.const_50)
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_67));
            }
         }
      ...
      {
         var _loc3_:AssetLoaderStruct = var_754.loadAssetFromFile("hotel_view_banner_" + var_915,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_553));
            }
            var_612 = param2;
      ...
      {
         var _loc3_:AssetLoaderStruct = var_754.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
