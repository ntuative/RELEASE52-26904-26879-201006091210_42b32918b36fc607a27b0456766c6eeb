package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_184:HabboHotelView;
      ...
      private var var_2170:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1588:ILogger;
      
      private var var_1355:String;
      
      private var var_2171:String;
      
      private const const_1458:String = "fuselogin";
      
      private var var_304:ICoreCommunicationManager;
      
      private var var_439:IKeyExchange;
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2172)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_764 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_764);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1355,var_2171));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1458,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_439.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_439.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_2170);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1458,"/");
      ...
      {
         var_764 = _habboConfiguration.getKey("sso.ticket",null);
         var_1355 = _habboConfiguration.getKey("flash.client.url","");
         var_2171 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_184 == null)
         {
            var_184 = new HabboHotelView(_windowManager,assets,Component(context).events);
         }
         if(var_764 != null)
         {
            var_60.mode = HabboConnectionType.const_383;
            var_60.initConnection(HabboConnectionType.const_285);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1588 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_595);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_2170 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_60.mode)
         {
            case HabboConnectionType.const_383:
               _loc6_ = "";
               ...
               var_1101 = _loc4_;
               var_184.loadBannerImage(_loc7_ + "?token=" + var_1101,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_874:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1392:
               var_622 = generateRandomHexString(30);
               var_439 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_439.init(var_622);
               _loc8_ = var_439.getPublicKey(10);
      ...
      private function onConfigurationLoaded(param1:Event = null) : void
      {
         ...
         {
            var_184.loadHotelViewImage(_loc3_ + _loc2_);
         }
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1101);
         ...
         var_439 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_439.init(_loc14_);
            _loc15_ = var_439.getPublicKey(10);
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               var_60.mode = HabboConnectionType.const_874;
            }
         }
         var_60.initConnection(HabboConnectionType.const_285);
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         dispatchLoginStepEvent(HabboCommunicationEvent.const_232);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_173,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_112,onRoomSessionEnded);
      }
