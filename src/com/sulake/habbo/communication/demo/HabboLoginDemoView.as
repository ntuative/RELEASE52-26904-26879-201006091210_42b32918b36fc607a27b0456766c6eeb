package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_715:String = "InitConnection";
      ...
      private var var_178:HabboCommunicationDemo;
      ...
      {
         var_178.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_178.shockwaveClientUrl = var_115.shockwaveClientUrl;
         var_178.ssoTicket = var_115.ticket;
         var_115.removeEventListener(SSOTicket.const_334,onParsedTicketSuccess);
         var_115.removeEventListener(SSOTicket.const_278,onParsedTicketFailure);
         var_115 = null;
         dispatchEvent(new Event(const_715));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1458,"/");
      ...
      {
         var _loc8_:* = null;
         var _loc1_:XmlAsset = (var_178 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_178.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_113,HabboWindowStyle.const_41,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_178.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1458,"/");
         if(_loc5_ != null)
         {
         ...
         if(false)
         {
            if(var_178.habboConfiguration.getKey("use.sso","false") == "RoomVisualizationData")
            {
      ...
      private function listEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_178.sendTryLogin(name,password,param2.id);
      }
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_178.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_178.habboCommunication.habboWebLogin(name,password);
         var_115 = new SSOTicket(var_178.assets,_loc2_,_loc1_);
         var_115.addEventListener(SSOTicket.const_334,onParsedTicketSuccess);
         var_115.addEventListener(SSOTicket.const_278,onParsedTicketFailure);
      }
      ...
      public function populateUserList(param1:Map) : void
      {
         ...
         var _loc3_:XmlAsset = var_178.assets.getAssetByName("login_user_list_item") as XmlAsset;
         var _loc4_:IWindow = var_178.windowManager.buildFromXML(_loc3_.content as XML);
