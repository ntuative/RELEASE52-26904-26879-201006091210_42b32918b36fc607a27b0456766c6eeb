package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_1032:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_585:uint = 0;
      
      public static const const_683:String = "AssetLibraryReady";
      
      public static const const_1332:String = "AssetLibraryUnloaded";
      
      public static const const_462:String = "AssetLibraryLoaded";
      
      public static const const_1213:String = "AssetLibraryLoadError";
       
      
      private var var_494:XML;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         var_709 = new Dictionary(false);
         var_130 = new Dictionary(false);
         var_1032.push(this);
      }
      ...
      public function unload() : void
      {
         ...
         var_305 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1332));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_494 = _loc2_.manifest.copy();
         var_354 = _loc2_.resource;
         _file = _loc2_.url;
         if(var_493)
         {
            AssetLibrary.fetchLibraryContents(this,var_494,var_354);
         }
         var_305 = true;
         dispatchEvent(new Event(AssetLibrary.const_462));
         dispatchEvent(new Event(AssetLibrary.const_683));
         if(var_493)
         {
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1037,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_962,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_860,assetLoadEventHandler);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_1032.splice(var_1032.indexOf(this),1);
            --var_585;
            var_408 = null;
            var_709 = null;
            var_130 = null;
      ...
      {
         return param1 < var_353.length ? getAssetByName(var_353[param1]) : null;
      }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1213));
         var_14 = null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in var_130)
         {
            if(var_130[_loc2_] == param1)
            {
               return var_353.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         var _loc2_:Class = var_709[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_494.child("library");
         if(_loc2_ == null)
         {
      ...
      {
         var _loc2_:IAsset = var_130[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_36:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++var_197;
                     var_353.push(struct.assetName);
                  }
                  var_130[struct.assetName] = asset;
               }
               else
               {
                  e = new AssetLoaderEvent(AssetLoaderEvent.const_50,e.status);
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in var_130)
            {
               if(var_130[_loc2_] == param1)
               {
                  var_353.splice(var_353.indexOf(_loc2_),1);
