package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1594:String = "_INCLUDE";
      
      public static const const_1002:String = "_EXCLUDE";
      
      public static const const_1696:String = "_TEMP";
      ...
      protected var var_1158:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_989:Dictionary;
      
      protected var var_1441:Map;
      
      protected var var_16:IWindowContext;
      
      protected var var_1442:Dictionary;
      
      protected var var_1157:Dictionary;
      
      public function WindowParser(param1:IWindowContext)
      {
         super();
         var_16 = param1;
         var_1157 = new Dictionary();
         var_1158 = new Dictionary();
         TypeCodeTable.fillTables(var_1157,var_1158);
         var_989 = new Dictionary();
         var_1442 = new Dictionary();
         ParamCodeTable.fillTables(var_989,var_1442);
         var_1441 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1157)
            {
               delete var_1157[_loc1_];
            }
            for(_loc1_ in var_1158)
            {
               delete var_1158[_loc1_];
            }
            for(_loc1_ in var_989)
            {
               delete var_989[_loc1_];
            }
            for(_loc1_ in var_1442)
            {
               delete var_1442[_loc1_];
            }
            var_1441.dispose();
            var_1441 = null;
            var_16 = null;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         visible = parseAttribute(xml,"visible",variables,visible.toString()) == "RoomVisualizationData";
         ...
         background = parseAttribute(xml,"background",variables,window.background.toString()) == "RoomVisualizationData";
         blend = Number(parseAttribute(xml,"blend",variables,window.blend.toString()));
         clipping = parseAttribute(xml,"clipping",variables,window.clipping.toString()) == "RoomVisualizationData";
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1002) == -1)
                  {
