package com.sulake.core.window.utils
{
   ...
   public class Iterator extends Proxy implements IIterator
   {
      ...
      private static const const_201:uint = 4;
      
      private static const const_1144:uint = 0;
      
      private static const const_203:uint = 2;
      ...
      public function Iterator(param1:WindowController)
      {
         ...
         {
            _type = Iterator.const_201;
         }
         else if(var_37 is IItemListWindow)
         {
            _type = Iterator.const_202;
         }
         else if(var_37 is ISelectorWindow)
         {
            _type = Iterator.const_203;
         }
