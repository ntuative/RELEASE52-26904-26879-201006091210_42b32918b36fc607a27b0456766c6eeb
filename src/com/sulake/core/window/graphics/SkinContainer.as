package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_784:uint = 8;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(var_1492,var_1845);
         var_1212 = new Dictionary();
         var_1846 = new Dictionary();
         StateCodeTable.fillTables(var_1212,var_1846);
         var_492 = new Dictionary();
         var_492["skin"] = BitmapSkinRenderer;
         var_492["bitmap"] = BitmapDataRenderer;
         var_492["fill"] = FillSkinRenderer;
         var_492["text"] = TextSkinRenderer;
         var_492["shape"] = ShapeSkinRenderer;
         var_492["unknown"] = SkinRenderer;
         var_492["null"] = NullSkinRenderer;
         if(var_386 == null)
         {
            var_386 = new Array();
            var_386.push(WindowState.const_70);
            var_386.push(WindowState.const_74);
            var_386.push(WindowState.const_104);
            var_386.push(WindowState.WINDOW_STATE_SELECTED);
            var_386.push(WindowState.const_84);
            var_386.push(WindowState.const_81);
            var_386.push(WindowState.const_97);
            var_386.push(WindowState.const_92);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1212)
         {
            _loc3_.push(var_1212[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc21_ < _loc6_)
               {
                  ...
                  _loc20_.background = !!_loc7_.@background[0] ? _loc7_.@background[0] == "RoomVisualizationData" : false;
                  ...
                  addSkinRenderer(var_1492[_loc9_],uint(_loc10_),_loc17_,_loc20_);
                  _loc21_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_705[param1];
         return _loc3_ != null ? _loc3_[param2] : null;
      }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         if(true)
         {
            var_705[param1] = new Array(SkinContainer.const_784);
         }
         var_705[param1][param2] = param3;
         if(true)
         {
            var_706[param1] = new Array(SkinContainer.const_784);
         }
         var_706[param1][param2] = param4;
      }
