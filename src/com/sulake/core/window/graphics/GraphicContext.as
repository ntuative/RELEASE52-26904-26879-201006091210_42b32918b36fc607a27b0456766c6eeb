package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_863:uint = 256;
      
      protected static var var_672:uint = 0;
      
      protected static var var_387:uint = 0;
      
      public static const const_914:uint = 2;
      
      public static const const_1561:uint = 128;
      
      public static const const_1523:uint = 64;
      
      public static const const_602:uint = 4;
      
      public static const const_1320:uint = 0;
      
      public static const const_1329:uint = 16;
      
      public static const const_650:uint = 1;
      
      public static const const_1344:uint = 8;
      ...
      protected var var_1674:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_914:
               ...
               break;
            case GraphicContext.const_1344:
               setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1329:
               setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_602:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_863:
               break;
            case GraphicContext.const_1320:
               break;
            default:
         ...
         if(var_669)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1674,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1674,16777215);
                  }
                  var_387 += bitmap.width * bitmap.height * 4;
               }
