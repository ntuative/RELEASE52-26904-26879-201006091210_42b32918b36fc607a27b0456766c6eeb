package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected var var_664:Function;
      
      protected var _children:Array;
      
      protected var var_662:Boolean = false;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_422 = _loc13_.blend;
            var_564 = _loc13_.treshold;
            if(var_666 != _loc13_.background)
            {
               background = _loc13_.background;
            }
            if(var_563 != _loc13_.color)
            {
               color = _loc13_.color;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_143,WindowParam.const_148);
         var _loc2_:* = !testParamFlag(WindowParam.const_126,WindowParam.const_153);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_8.clone();
            if(_loc1_)
            ...
            if(_loc2_)
            {
               _loc4_ = 0 - 0;
               _loc5_ = uint(_param & 0);
               if(_loc5_ == WindowParam.const_295)
               {
                  _loc3_.height += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_308)
               {
                  _loc3_.y += _loc4_;
               }
      ...
      {
         var_666 = param1;
         var_563 = !!var_666 ? uint(var_563 | var_1444) : uint(var_563 & 16777215);
      ...
      {
         var_564 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2072 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1034:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_325:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_877:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1437:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_1013:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_492:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_504:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_693:
               _loc2_ = "null";
               break;
         ...
         if(_loc2_ == WindowEvent.const_182)
         {
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_81 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_492,this,null));
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_17)
         {
            var_17 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_650,var_8);
            var_17.visible = var_364;
         }
         return var_17;
      }
      ...
      public function set blend(param1:Number) : void
      {
         ...
         var_16.invalidate(this,var_8,WindowRedrawFlag.const_887);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_1073 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_362,this,param1));
         return param1;
      }
      ...
      {
         return testLocalPointHitAgainstAlpha(param1,param2,var_564);
      }
      
      public function set color(param1:uint) : void
      {
         var_1444 = param1 & 4278190080;
         var_563 = !!var_666 ? uint(param1) : uint(param1 & 16777215);
         var_16.invalidate(this,var_8,WindowRedrawFlag.const_80);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_535))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  setStateFlag(WindowState.const_104,true);
                  _loc4_ = var_16.getWindowServices().getMouseListenerService();
                  _loc4_.begin(this);
                  _loc4_.eventTypes.push(MouseEvent.MOUSE_UP);
                  _loc4_.areaLimit = MouseListenerType.const_851;
                  if(testParamFlag(WindowParam.const_306))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
                  ...
                  if((_param & 0) > 0)
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_282))
                        {
               ...
               case MouseEvent.MOUSE_UP:
                  if(testStateFlag(WindowState.const_104))
                  {
                     setStateFlag(WindowState.const_104,false);
                  }
                  ...
                  if(testParamFlag(WindowParam.const_282))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_185:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_428,this,null));
                     if(testParamFlag(WindowParam.const_172,WindowParam.const_148))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_179,WindowParam.const_153))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_9 != null)
                     {
                        _loc8_ = uint(_param);
                        _param &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_415))
                        {
                           var_9.width += 0 - 0;
                        }
                  ...
                  break;
               case WindowNotifyEvent.const_440:
                  var_16.invalidate(this,var_8.union(var_57),WindowRedrawFlag.const_417);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_993,this,null));
                     if(var_9 != null)
                     {
               ...
               case WindowNotifyEvent.const_325:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_693,this,null));
                     if(var_9 != null)
                     {
                        var_9.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_228,var_9,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_416:
                  var_16.invalidate(this,var_8,WindowRedrawFlag.const_933);
                  break;
               case WindowNotifyEvent.const_492:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_504:
                  if(!(_param & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        var_16.invalidate(this,var_8,WindowRedrawFlag.const_417);
                     }
                  }
                  else if(_param & 0)
                  {
               ...
               case WindowNotifyEvent.const_228:
                  ...
                  break;
               case WindowNotifyEvent.const_428:
                  var_9.getRegionProperties(null,var_314);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_362:
      ...
      {
         return var_664 != null ? var_664 : (var_9 != null ? var_9.procedure : nullEventProc);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return testLocalPointHitAgainstAlpha(_loc3_,param2,var_564);
      }
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_325;
         update(this,_loc1_);
         return true;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_697,this,param1));
         return param1;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_609;
         update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_1073 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            var_36 = param1;
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_416,this,null));
         }
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_403)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_1031,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_606,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_185,this,null));
            }
         }
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1237,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_70,true);
         _loc1_.type = WindowNotifyEvent.const_1203;
         update(this,_loc1_);
         return true;
      }
         ...
         if(var_167 && var_564 > 0)
         {
            if(!testParamFlag(WindowParam.const_35))
            {
               if(param1.x <= var_8.width && param1.y <= var_8.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1556,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1556,param3,param1)) : false;
            }
         }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1436,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_70,false);
         _loc1_.type = WindowNotifyEvent.const_1428;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_9 != param1)
         {
            ...
            if(var_9 != null)
            {
               var_314 = var_9.rectangle.clone();
               var_57.x = var_8.x;
               var_57.y = var_8.y;
               var_57.width = var_8.width;
               var_57.height = var_8.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_420,this,var_9));
            }
            else
            {
               var_314.x = 0;
      ...
      public function setParamFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(_param != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_504,this,null));
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_81,_param,var_16,var_8,null,var_664,properties,var_665.concat(),_id) as WindowController;
         _loc2_.var_564 = var_564;
         _loc2_.var_167 = var_167;
         _loc2_.var_662 = var_662;
         _loc2_.var_314 = var_314.clone();
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_451;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      {
         if(var_36 == WindowState.const_482)
         {
            return true;
         }
