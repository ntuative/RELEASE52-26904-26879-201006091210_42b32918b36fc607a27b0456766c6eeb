package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1121:String = "content";
      ...
      protected var var_986:ITabSelectorWindow;
      
      private var var_895:Boolean = false;
      
      protected var var_1669:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1669 == null)
         {
            var_1669 = findChildByTag(TabContextController.const_1121) as IWindowContainer;
         }
         return var_1669;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_986 == null)
         {
            var_986 = findChildByTag(TabContextController.const_1120) as ITabSelectorWindow;
            if(var_986 != null)
            {
               var_986.procedure = selectorEventProc;
            }
         }
         return var_986;
      }
      ...
      {
         return !!var_895 ? selector.iterator : null;
      }
