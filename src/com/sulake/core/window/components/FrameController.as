package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_820:String = "margin_top";
      
      private static const const_1151:String = "_HEADER";
      
      private static const const_819:String = "margin_right";
      
      private static const const_1149:String = "_SCALER";
      
      private static const const_1124:String = "_TITLE";
      
      private static const const_1150:String = "_CONTENT";
      
      private static const const_821:String = "margin_left";
      
      private static const const_818:String = "margin_bottom";
      ...
      private var var_1394:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_821,_loc3_.left,PropertyStruct.const_65,_loc2_));
         _loc1_.push(new PropertyStruct(const_820,_loc3_.top,PropertyStruct.const_65,_loc2_));
         _loc1_.push(new PropertyStruct(const_819,0 - _loc3_.right,PropertyStruct.const_65,_loc2_));
         _loc1_.push(new PropertyStruct(const_818,0 - _loc3_.bottom,PropertyStruct.const_65,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_282);
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1394 == null)
         {
            var_1394 = findChildByTag(const_1151) as IHeaderWindow;
            if(!var_1394)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1124) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1149) as IScalerWindow;
      }
      ...
      {
         return content != null && var_559 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_20 == null)
         {
            var_20 = findChildByTag(const_1150) as IWindowContainer;
            if(!var_20)
            {
