package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         name_1.scrollable = _itemList;
         if(name_1.testStateFlag(WindowState.const_74))
         {
            hideScrollBar();
         }
      }
      ...
      protected function get name_1() : IScrollbarWindow
      {
         if(!var_377)
         {
            var_377 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_377)
            {
               var_377.addEventListener(WindowEvent.const_261,scrollBarEventProc);
               var_377.addEventListener(WindowEvent.const_247,scrollBarEventProc);
            }
         }
         return var_377;
      }
      ...
      override public function dispose() : void
      {
         if(var_377)
         {
            var_377.removeEventListener(WindowEvent.const_261,scrollBarEventProc);
            var_377.removeEventListener(WindowEvent.const_247,scrollBarEventProc);
            var_377 = null;
         }
         if(var_956)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_956)
         {
            var_956 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_956;
      }
