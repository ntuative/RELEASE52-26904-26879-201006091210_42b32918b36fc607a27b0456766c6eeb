package com.sulake.core.window.components
{
   ...
   public class HeaderController extends ContainerController implements IHeaderWindow
   {
      ...
      private static const const_1123:String = "_CONTROLS";
      ...
      {
         return findChildByTag(HeaderController.const_1124) as ITextWindow;
      }
      
      public function get controls() : IItemListWindow
      {
         return findChildByTag(HeaderController.const_1123) as IItemListWindow;
      }
   }
}
