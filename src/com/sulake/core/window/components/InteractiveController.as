package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected static const const_1438:uint = 500;
      
      protected static const const_771:String = "";
      ...
      protected var var_992:uint = 500;
      ...
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         {
            var_335 = new Array();
            var_335[0] = WindowState.const_97;
            ...
            var_335[5] = WindowState.const_104;
            var_335[6] = WindowState.const_74;
         }
      ...
      {
         param2.push(new PropertyStruct(const_1055,param1.toolTipCaption,PropertyStruct.STRING,param1.toolTipCaption != const_771));
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_984,param1.toolTipDelay != const_1438));
         return param2;
      }
         ...
         for each(_loc3_ in param2)
         {
            switch(_loc3_.key)
            {
               ...
               case "mouse_cursor_pressed":
                  param1.setMouseCursorByState(WindowState.const_104,_loc3_.value as uint);
                  break;
      ...
      {
         if(param1.toolTipCaption != const_771)
         {
      ...
      {
         var_991 = param1 == null ? const_771 : param1;
      }
