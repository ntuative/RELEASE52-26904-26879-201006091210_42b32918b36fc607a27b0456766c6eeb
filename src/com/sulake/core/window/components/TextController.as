package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2423:Rectangle = new Rectangle();
      ...
      protected var var_557:String = "none";
      
      protected var var_661:Number;
      
      protected var var_381:Number;
      
      protected var _field:TextField;
      
      protected var var_802:Boolean = false;
      ...
      {
         return new Rectangle(var_661 * maxScrollH,var_381 * maxScrollV,width,height);
      }
      ...
      {
         var_661 = param1;
         _field.scrollH = var_661 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!var_216)
         {
            if(param2.type == WindowNotifyEvent.const_185)
            {
               refreshTextImage();
            }
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_984,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_484,true));
         _loc1_.push(new PropertyStruct("antialias_type",_field.antiAliasType,PropertyStruct.STRING,true));
         _loc1_.push(new PropertyStruct("always_show_selection",_field.alwaysShowSelection,PropertyStruct.const_64,true));
         _loc1_.push(new PropertyStruct("border",_field.border,PropertyStruct.const_64,false));
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_484,true));
         _loc1_.push(new PropertyStruct("condense_white",_field.condenseWhite,PropertyStruct.const_64,true));
         _loc1_.push(new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_64,true));
         _loc1_.push(new PropertyStruct("embed_fonts",_field.embedFonts,PropertyStruct.const_64,true));
         _loc1_.push(new PropertyStruct("grid_fit_type",_field.gridFitType,PropertyStruct.STRING,true));
         _loc1_.push(new PropertyStruct("max_chars",_field.maxChars,PropertyStruct.const_65,true));
         _loc1_.push(new PropertyStruct("mouse_wheel_enabled",_field.mouseWheelEnabled,PropertyStruct.const_64,true));
         _loc1_.push(new PropertyStruct("multiline",_field.multiline,PropertyStruct.const_64,true));
         _loc1_.push(new PropertyStruct("restrict",_field.restrict,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_638,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_638,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_64,true));
         _loc1_.push(new PropertyStruct("margin_left",var_69.left,PropertyStruct.const_65,true));
         _loc1_.push(new PropertyStruct("margin_top",var_69.top,PropertyStruct.const_65,true));
         _loc1_.push(new PropertyStruct("margin_right",var_69.right,PropertyStruct.const_65,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_69.bottom,PropertyStruct.const_65,true));
         _loc1_.push(new PropertyStruct("auto_size",var_557,PropertyStruct.STRING,var_557 != TextFieldAutoSize.NONE));
         _loc1_.push(new PropertyStruct("bold",_field.defaultTextFormat.bold != false,PropertyStruct.const_64,_field.defaultTextFormat.bold != false));
         _loc1_.push(new PropertyStruct("italic",_field.defaultTextFormat.italic != false,PropertyStruct.const_64,_field.defaultTextFormat.italic != false));
         _loc1_.push(new PropertyStruct("underline",_field.defaultTextFormat.underline != false,PropertyStruct.const_64,_field.defaultTextFormat.underline != false));
         _loc1_.push(new PropertyStruct("kerning",_field.defaultTextFormat.kerning != false,PropertyStruct.const_64,_field.defaultTextFormat.kerning != false));
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_638,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_661 = var_661;
         _loc1_.var_381 = var_381;
         _loc1_.var_69 = var_69.clone(_loc1_.setTextMargins);
         _loc1_.var_557 = var_557;
         _loc1_.var_802 = var_802;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_557 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_557 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_557 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_557 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_8.x,var_8.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
