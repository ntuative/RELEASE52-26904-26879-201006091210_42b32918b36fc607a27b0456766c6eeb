package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1158:String = "increment";
      
      private static const const_529:String = "slider_bar";
      
      private static const const_1157:String = "decrement";
      ...
      protected var var_805:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_167 = false;
         var_21 = param12;
         _horizontal = param2 == WindowType.const_450;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_529:
         ...
         if(param2.type == WindowNotifyEvent.const_420)
         {
            if(var_21 == null)
            {
               resolveScrollTarget();
      ...
      {
         return findChildByName(ScrollbarController.const_824) as WindowController;
      }
      ...
      {
         return track.findChildByName(ScrollbarController.const_529) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_964 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_964 != null)
         {
            _loc1_ = findParentByName(var_964) as IScrollableWindow;
            if(_loc1_ == null && var_9 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_9).findChildByName(var_964) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1158)
            {
               if(var_21)
               {
                  var_646 = true;
            ...
            else if(param2.name == ScrollbarController.const_1157)
            {
               if(var_21)
               {
                  var_646 = true;
            ...
            else if(param2.name == ScrollbarController.const_824)
            {
               _loc4_ = new Point();
               ...
               _loc5_ = WindowController(param2).getChildByName(ScrollbarController.const_529).rectangle;
               if(_horizontal)
               {
         ...
         if(param1.type == WindowMouseEvent.const_960)
         {
