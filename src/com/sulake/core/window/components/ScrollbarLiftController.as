package com.sulake.core.window.components
{
   ...
   public class ScrollbarLiftController extends InteractiveController implements IDragBarWindow
   {
      ...
      protected var var_870:Number;
      
      protected var _offsetX:Number;
      
      protected var name_1:ScrollbarController;
      ...
      public function ScrollbarLiftController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         while(_loc12_ != null)
         {
            ...
            {
               name_1 = ScrollbarController(_loc12_);
               _loc12_ = null;
            }
            else
            {
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(param2.type == WindowNotifyEvent.const_440)
         {
            ...
            var_870 = y != 0 ? Number(y / Number(0 - height)) : Number(0);
            if(var_9 != name_1)
            {
               name_1.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_296,this,null));
            }
         }
