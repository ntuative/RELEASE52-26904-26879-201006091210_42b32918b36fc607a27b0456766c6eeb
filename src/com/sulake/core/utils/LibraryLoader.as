package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1440:uint = 1;
      
      public static const const_867:int = 5;
      
      protected static const const_1170:uint = 7;
      
      protected static const const_1443:uint = 4;
      ...
      protected var var_559:Boolean = false;
      
      protected var var_803:int;
      
      protected var var_462:uint = 0;
      
      protected var var_14:Loader;
      
      protected var var_2357:String = "";
      ...
      protected function prepareLibrary() : void
      {
         ...
         var_494 = new XML(bytes.readUTFBytes(bytes.length));
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(var_462 == LibraryLoader.const_1442)
         {
            if(analyzeLibrary())
            {
               var_462 |= 0;
         ...
         if(var_462 == LibraryLoader.const_1170)
         {
            var_559 = true;
            var_190 = getTimer();
            prepareLibrary();
      ...
      {
         return !!var_559 ? uint(var_190 - var_803) : uint(getTimer() - var_803);
      }
