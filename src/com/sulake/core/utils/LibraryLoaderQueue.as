package com.sulake.core.utils
{
   ...
   public class LibraryLoaderQueue extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1448:int = 4;
      ...
      private function removeLoader(param1:LibraryLoader) : void
      {
         ...
         _loc2_ = var_620.indexOf(param1);
         if(_loc2_ > -1)
         {
            var_620.splice(_loc2_,1);
         }
         _loc2_ = var_250.indexOf(param1);
         if(_loc2_ > -1)
         {
      ...
      private function next() : void
      {
         ...
         if(!disposed)
         {
            while(var_250.length < const_1448 && false)
            {
               _loc1_ = var_620.shift();
               var_250.push(_loc1_);
               _loc1_.resume();
            }
         }
