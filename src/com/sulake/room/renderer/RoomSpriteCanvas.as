package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1454:int = 50;
      ...
      private var var_220:BitmapDataCache;
      
      private var _geometry:RoomGeometry;
      
      private var var_1480:Boolean = false;
      
      private var var_1788:Number = -1.0E7;
      
      private var var_1787:Number = -1.0E7;
      
      private var var_2429:int = 0;
      
      private var var_485:RoomObjectCache;
      
      private var var_690:int;
      
      private var var_254:Sprite;
      
      private var var_1014:IRoomRenderingCanvasMouseListener = null;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         var_220 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
         if(_container != null)
         {
            _loc6_ = "null";
         ...
         var_299 = new Map();
         var_485 = new RoomObjectCache(_loc6_);
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(param2.length > 0)
         {
            _loc5_ = var_220.getBitmapData(_loc4_);
            if(!param3)
            {
               return _loc5_;
            }
         ...
         if(_loc5_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_220.addBitmapData(_loc4_,_loc5_);
            }
         }
         return _loc5_;
      }
      ...
      {
         var_485.removeObjectCache(param1);
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(var_254 != null)
         {
            var_254.graphics.clear();
         }
         else
         {
            var_254 = new Sprite();
            var_254.name = "mask";
            _master.addChild(var_254);
         }
         var_254.graphics.beginFill(0);
         var_254.graphics.drawRect(0,0,param1,param2);
         var_690 = param1;
         var_689 = param2;
         var_52.graphics.clear();
         var_52.graphics.beginFill(var_2429);
      ...
      private function createMouseEvent(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String, param7:Boolean, param8:Boolean, param9:Boolean, param10:Boolean) : RoomSpriteMouseEvent
      {
         ...
         var _loc12_:Number = param2 - var_689 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_690 != var_1786 || var_689 != var_1789)
         {
            _loc9_ = true;
         }
         _loc4_ = 0;
         ...
         var_398.sortOn("z",0 | 0);
         if(_loc5_ < var_398.length)
         {
            var_398.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = var_398[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
      ...
      public function dispose() : void
      {
         ...
         if(var_484 != null)
         {
            ...
            {
               cleanSprite(var_484[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_484 = [];
         }
         ...
         while(_loc1_ < var_299.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1014 != null)
                  {
                     var_1014.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1479,geometry);
                  }
                  else
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        _loc5_.method_2(_loc3_,_geometry);
                     }
                  }
               }
            }
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(param2.length > 0)
         {
            _loc6_ = var_220.getBitmapData(_loc5_);
            if(!param4)
            {
               return _loc6_;
            }
         ...
         if(_loc6_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_220.addBitmapData(_loc5_,_loc6_);
            }
         }
         return _loc6_;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         var_1015.x = param1;
         var_1015.y = param2;
         if(var_824 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return var_1480;
         }
         var_1480 = checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++var_824;
         return var_1480;
      }
      ...
      {
         if(param1 < 0 || param1 >= var_398.length)
         {
            return null;
         }
         return var_398[param1] as SortableSprite;
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_1788 || param2 != var_1787)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_484.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = var_220.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     var_220.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            var_485.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = var_485.getObjectCache(param2);
         ...
         while(_loc22_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc23_ != null)
               {
                  ...
                  if(_loc19_ + _loc23_.width >= 0 && _loc19_ < var_690 && (_loc20_ + _loc23_.height >= 0 && _loc20_ < var_689))
                  {
