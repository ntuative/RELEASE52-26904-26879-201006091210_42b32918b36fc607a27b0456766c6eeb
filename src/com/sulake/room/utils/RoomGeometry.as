package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_655:Number = 64;
      
      public static const const_988:Number = 32;
       
      
      private var var_72:Vector3d;
      
      private var var_414:Number = 1.0;
      
      private var var_413:Number = 1.0;
      ...
      private var var_1513:Number = 1.0;
      
      private var var_2430:Number = 500.0;
      ...
      private var var_2431:Number = -500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_87 = new Vector3d();
         var_1038 = new Vector3d();
         var_1511 = 1;
         var_1512 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1513 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_413 != param1 * var_1513)
         {
            var_413 = param1 * var_1513;
            ++var_78;
         }
      }
      ...
      {
         if(var_414 != param1 * var_1511)
         {
            var_414 = param1 * var_1511;
            ++var_78;
         }
      }
      ...
      {
         if(var_411 != param1 * var_1512)
         {
            var_411 = param1 * var_1512;
            ++var_78;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_412 != null)
         {
            ...
            var_412.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_412.add(_loc3_,_loc4_);
            ++var_78;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1038.assign(_loc22_);
         }
         else
         {
            var_1038.assign(_loc17_);
         }
         ++var_78;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_411;
         _loc2_.z *= var_413;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1038);
         if(_loc3_ < var_2431 || _loc3_ > var_2430)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_411;
            _loc2_.z *= var_413;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1038);
         }
      ...
      {
         return new Vector3d(0 * var_414,0 * var_411,0 * var_413);
      }
      ...
      {
         return scale == const_655;
      }
      
      public function get scale() : Number
      {
         return var_149 / Math.sqrt(0.5);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_412 != null)
         {
            ...
            return var_412.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc5_:Number = param1.x / var_149;
         var _loc6_:Number = -param1.y / var_149;
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(var_88,_loc5_),Vector3d.product(_y,_loc6_));
         var _loc8_:Vector3d = new Vector3d(0 * var_414,0 * var_411,0 * var_413);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_87;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_414,param2.y * var_411,param2.z * var_413);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_414,param3.y * var_411,param3.z * var_413);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_414,param4.y * var_411,param4.z * var_413);
