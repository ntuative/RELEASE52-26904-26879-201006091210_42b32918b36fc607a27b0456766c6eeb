package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               ...
               case 101010256:
                  ...
                  break;
               default:
                  dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_136,"Unknown record signature."));
            }
            return true;
         }
         return false;
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_136))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_136,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_97 && var_96 == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_136,"EOF"));
            }
         }
      }
      ...
      private function parseLocalfile(param1:IDataInput) : Boolean
      {
         if(var_536.parse(param1))
         {
            ...
            if(false)
            {
               var_137["null"] = var_536;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1217,var_536));
            var_536 = null;
            if(var_96 != parseIdle)
            {
               var_96 = parseSignature;
      ...
      {
         var _loc2_:* = null;
         if(var_49 != null && var_137 != null && param1 < var_49.length)
         {
